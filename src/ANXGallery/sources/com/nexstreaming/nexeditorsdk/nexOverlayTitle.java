...
final class nexOverlayTitle {
    ...
    public String a(Context context, nexProject nexproject, List<nexTitleInfo> list) {
        ...
        while (it.hasNext()) {
            ...
            if (str3.equals(SimpleDialogFragment.ARG_TITLE) && hashMap.containsKey("group") && ((String) hashMap.get("group")).endsWith("_1")) {
                String str4;
                String[] split;
                if (str == null) {
                        ...
                        if (!a && hashMap.containsKey("group") && ((String) hashMap.get("group")).endsWith("_2")) {
                            ...
                            switch (str3.hashCode()) {
                                case 100313435:
                                    ...
                                    break;
                                case 110371416:
                                    if (str3.equals(SimpleDialogFragment.ARG_TITLE)) {
                                        obj = null;
                                        break;
                                    }
                                    break;
