...
public class ActionModeImpl extends ActionMode implements Callback, ActionModeAnimationListener {
    ...
    private ActionMode.Callback mf;
    boolean mg = false;
    ...
    public boolean dispatchOnCreate() {
        ...
        try {
            boolean onCreateActionMode = this.mf.onCreateActionMode(this, this.mMenu);
    ...
    public void invalidate() {
        this.mMenu.stopDispatchingItemsChanged();
        try {
            this.mf.onPrepareActionMode(this, this.mMenu);
        } finally {
            this.mMenu.startDispatchingItemsChanged();
        }
    }
    ...
    public boolean onMenuItemSelected(MenuBuilder menuBuilder, MenuItem menuItem) {
        return this.mf != null && this.mf.onActionItemClicked(this, menuItem);
    }
    ...
    public void onStop(boolean z) {
        if (!z) {
            this.mf.onDestroyActionMode(this);
            this.mf = null;
        }
    }
}
