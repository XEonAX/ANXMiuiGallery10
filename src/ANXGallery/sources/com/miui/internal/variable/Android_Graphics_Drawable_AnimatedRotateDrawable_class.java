...
public abstract class Android_Graphics_Drawable_AnimatedRotateDrawable_class extends Android_Graphics_Drawable_Drawable_class {
    ...
    public static class Factory extends AbsClassFactory {
        ...
        private Android_Graphics_Drawable_AnimatedRotateDrawable_class ki;

        private Factory() {
            this.ki = (Android_Graphics_Drawable_AnimatedRotateDrawable_class) create("Android_Graphics_Drawable_AnimatedRotateDrawable_class");
        }
