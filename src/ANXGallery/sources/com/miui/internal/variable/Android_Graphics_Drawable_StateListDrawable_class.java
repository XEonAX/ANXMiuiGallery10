...
public abstract class Android_Graphics_Drawable_StateListDrawable_class extends Android_Graphics_Drawable_Drawable_class {
    ...
    public static class Factory extends AbsClassFactory {
        ...
        private Android_Graphics_Drawable_StateListDrawable_class km;

        private Factory() {
            this.km = (Android_Graphics_Drawable_StateListDrawable_class) create("Android_Graphics_Drawable_StateListDrawable_class");
        }
