...
public abstract class Android_Preference_Preference_class extends ClassProxy<Preference> implements IManagedClassProxy {
    ...
    public static class Factory extends AbsClassFactory {
        ...
        private Android_Preference_Preference_class kv;
        ...
        private Factory() {
            this.kv = (Android_Preference_Preference_class) create("Android_Preference_Preference_class");
        }
    ...
    private void a(View view, Preference preference) {
        ...
        if (TextUtils.isEmpty(preference.getTitle())) {
            if (order == 0) {
                view.setBackgroundResource(R.drawable.preference_category_background_first_no_title);
            } else {
                view.setBackgroundResource(R.drawable.preference_category_background_no_title);
            }
        } else if (order == 0) {
    ...
    private void a(View view, Preference preference, PreferenceGroup preferenceGroup) {
        ...
        } else if (preference == preferenceGroup.getPreference(0)) {
            view.setBackgroundResource(R.drawable.preference_category_background_first);
        } else {
            view.setBackgroundResource(R.drawable.preference_category_background);
        }
