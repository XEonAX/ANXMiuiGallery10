...
public class Android_App_ResourcesManager_class extends com.miui.internal.variable.Android_App_ResourcesManager_class {
    private static final Android_Content_Res_AssetManager_class mc = Factory.getInstance().get();
    private static final Android_Content_Res_ResourcesImpl_class md = Android_Content_Res_ResourcesImpl_class.Factory.getInstance().get();
    ...
    protected ResourcesImpl handleCreateResourcesImpl(long j, Object obj, ResourcesKey resourcesKey) {
        ...
        AssetManager assets = md.getAssets(originalCreateResourcesImpl);
        for (String addAssetPath : mAppendedAssetPaths) {
            mc.addAssetPath(assets, addAssetPath);
        }
        return originalCreateResourcesImpl;
    }
