...
public class Android_Content_Res_ResourcesImpl_class extends com.miui.internal.variable.Android_Content_Res_ResourcesImpl_class {
    ...
    private static final Method me = Method.of(ResourcesImpl.class, "getAssets", "()Landroid/content/res/AssetManager;");
    ...
    public AssetManager getAssets(ResourcesImpl resourcesImpl) {
        try {
            return (AssetManager) me.invokeObject(ResourcesImpl.class, resourcesImpl, new Object[0]);
        } catch (Throwable e) {
