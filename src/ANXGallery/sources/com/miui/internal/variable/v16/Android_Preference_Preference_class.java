...
public class Android_Preference_Preference_class extends com.miui.internal.variable.Android_Preference_Preference_class {
    private static final Field lw = Field.of(PreferenceManager.class, "mPreferenceScreen", "Landroid/preference/PreferenceScreen;");

    protected PreferenceScreen getPreferenceScreen(Preference preference) {
        try {
            return (PreferenceScreen) lw.get(preference.getPreferenceManager());
        } catch (Throwable e) {
