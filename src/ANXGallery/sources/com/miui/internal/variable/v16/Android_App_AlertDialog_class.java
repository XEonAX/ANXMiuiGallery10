...
public class Android_App_AlertDialog_class extends com.miui.internal.variable.Android_App_AlertDialog_class {
    private static final Field kY = Field.of(AlertDialog.class, "mAlert", "Lcom/android/internal/app/AlertController;");
    ...
    private void a(AlertDialog alertDialog) {
        try {
            kY.set((Object) alertDialog, new AlertControllerWrapper(alertDialog.getContext(), alertDialog, alertDialog.getWindow()));
        } catch (Throwable e) {
