...
public class Android_Widget_ListPopupWindow_class extends com.miui.internal.variable.Android_Widget_ListPopupWindow_class {
    private static final Field lO = Field.of(ListPopupWindow.class, "mPopup", "Landroid/widget/PopupWindow;");
    private static final Field lP = Field.of(ListPopupWindow.class, "mDropDownHorizontalOffset", Field.INT_SIGNATURE_PRIMITIVE);

    public void setPopupWindow(ListPopupWindow listPopupWindow, PopupWindow popupWindow) {
        lO.set((Object) listPopupWindow, (Object) popupWindow);
    }
    ...
    protected void handleShow(long j, ListPopupWindow listPopupWindow) {
        Object obj;
        int i = lP.getInt(listPopupWindow);
        View anchorView = listPopupWindow.getAnchorView();
        if (i == 0 || anchorView == null || !(anchorView instanceof Spinner)) {
            obj = null;
        } else {
            obj = 1;
            lP.set((Object) listPopupWindow, i - anchorView.getPaddingLeft());
        }
        originalShow(j, listPopupWindow);
        if (obj != null) {
            lP.set((Object) listPopupWindow, i);
        }
    }
