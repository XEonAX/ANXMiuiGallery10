...
public class Internal_Policy_Impl_PhoneWindow_class extends com.miui.internal.variable.Internal_Policy_Impl_PhoneWindow_class {
    private static final Field lR = a(TARGET_CLASS, "mLayoutInflater");

    private static class LayoutInflaterWrapper extends LayoutInflater {
        private static final miui.reflect.Field lU = miui.reflect.Field.of(LayoutInflater.class, "mContext", "Landroid/content/Context;");
        private static final Field lV = Internal_Policy_Impl_PhoneWindow_class.a(Internal_Policy_Impl_PhoneWindow_class.TARGET_CLASS, "mTitle");
        private LayoutInflater lS;
        private Window lT;

        private LayoutInflaterWrapper(LayoutInflater layoutInflater, Window window) {
            super((Context) lU.get(layoutInflater));
            this.lS = layoutInflater;
            this.lT = window;
        }

        public LayoutInflater cloneInContext(Context context) {
            return new LayoutInflaterWrapper(this.lS.cloneInContext(context), this.lT);
        }

        public View inflate(int i, ViewGroup viewGroup, boolean z) {
            i = ActivityDelegate.getDecorViewLayoutRes(this.lT);
            View inflate = this.lS.inflate(i, viewGroup, z);
        ...
        private void b(Context context, View view) {
            ...
            try {
                charSequence = (CharSequence) lV.get(this.lT);
    ...
    private LayoutInflaterWrapper a(Window window) {
        try {
            LayoutInflaterWrapper layoutInflaterWrapper = new LayoutInflaterWrapper((LayoutInflater) lR.get(window), window);
            lR.set(window, layoutInflaterWrapper);
    ...
    private void a(Window window, LayoutInflaterWrapper layoutInflaterWrapper) {
        try {
            lR.set(window, layoutInflaterWrapper.lS);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
