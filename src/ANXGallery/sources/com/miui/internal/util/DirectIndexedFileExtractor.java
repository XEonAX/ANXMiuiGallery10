...
public class DirectIndexedFileExtractor {
    ...
    private static final int iz = 436;
    private static final int jg = 505;
    private static final String jh = "idf";
    private static final String ji = ".idf";
    private static final String jj = "-tmp";
        ...
        try {
            ...
            new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... voidArr) {
                    for (String str : list) {
                        if (str.endsWith(DirectIndexedFileExtractor.ji)) {
    ...
    private static void k(Context context) {
        ...
        if (IDF_FILES_PATH != null) {
            ...
            if (!file.exists() && file.mkdirs()) {
                FileUtils.chmod(IDF_FILES_PATH, jg);
                return;
            }
            return;
        }
                ...
                try {
                    ...
                    try {
                        ...
                        if (copyToFile && file2.renameTo(file)) {
                            FileUtils.chmod(directIndexedFilePath, iz);
                            String str2 = TAG;
    ...
    public static boolean replaceDirectIndexedFile(Context context, String str, String str2) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            if (copyFile && file.renameTo(file2)) {
                ...
                z = FileUtils.chmod(directIndexedFilePath, iz);
            } else {
                boolean delete;
                if (file.exists()) {
                    delete = file.delete();
