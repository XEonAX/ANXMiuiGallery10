...
public class TaggingDrawableHelper {
    ...
    private static final Android_View_View_class js = Android_View_View_class.Factory.getInstance().get();
    private static final Android_View_ViewGroup_class jt = Android_View_ViewGroup_class.Factory.getInstance().get();
    static int[] ju = new int[]{R.attr.children_sequence_state};
    private static final ThreadLocal<Rect> jv = new ThreadLocal();

    private TaggingDrawableHelper() {
    }

    public static void tagChildSequenceState(ViewGroup viewGroup) {
        if (jt.getTagChildrenSequenceState(viewGroup)) {
    ...
    private static void a(View view, int i, int i2) {
        int horizontalState = js.getHorizontalState(view);
        int verticalState = js.getVerticalState(view);
        if (horizontalState != i || verticalState != i2) {
            js.setHorizontalState(view, i);
            js.setVerticalState(view, i2);
    ...
    public static void initTagChildSequenceState(ViewGroup viewGroup, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = viewGroup.getContext().obtainStyledAttributes(attributeSet, ju);
        boolean z = obtainStyledAttributes.getBoolean(0, true);
        obtainStyledAttributes.recycle();
        jt.setTagChildrenSequenceState(viewGroup, z);
    }

    public static void initViewSequenceStates(View view, AttributeSet attributeSet) {
        if (!js.hasInitViewSequenceStates(view)) {
            js.setHasInitViewSequenceStates(view, true);
