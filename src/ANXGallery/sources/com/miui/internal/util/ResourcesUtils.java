...
public class ResourcesUtils {
    ...
    private static Constructor<AssetManager> jp;

    static {
        try {
            jo = AssetManager.class.getMethod("addAssetPath", new Class[]{String.class});
            jp = AssetManager.class.getConstructor(new Class[0]);
    ...
    public static Resources createResources(Resources resources, String... strArr) {
        ...
        try {
            assetManager = (AssetManager) jp.newInstance(new Object[0]);
            try {
                for (Object obj : strArr) {
                    jo.invoke(assetManager, new Object[]{obj});
                }
