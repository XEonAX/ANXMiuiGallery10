...
public class DeviceAccountLogin {
    ...
    private AccountManagerCallback<Bundle> pu = new LoginCallback(this);

    private static class LoginCallback implements AccountManagerCallback<Bundle> {
        private WeakReference<DeviceAccountLogin> pv;

        public LoginCallback(DeviceAccountLogin deviceAccountLogin) {
            this.pv = new WeakReference(deviceAccountLogin);
        }

        public void run(AccountManagerFuture<Bundle> accountManagerFuture) {
            DeviceAccountLogin deviceAccountLogin = (DeviceAccountLogin) this.pv.get();
    ...
    public void login(String str, String str2, String str3) {
        ...
        if (account != null) {
            ...
            this.mAccountManager.getAuthToken(account, stringBuilder.toString(), null, null, this.pu, null);
        } else {
            onLoginCancel();
        }
    }
