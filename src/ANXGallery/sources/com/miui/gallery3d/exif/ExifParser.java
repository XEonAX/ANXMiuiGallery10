...
class ExifParser {
    ...
    private ExifTag readTag() throws IOException, ExifInvalidFormatException {
        ...
        if (numOfComp > 100000) {
            throw new ExifInvalidFormatException(String.format(Locale.US, "Number of component of tag %d [%d] is larger than [%d]", new Object[]{Short.valueOf(tagId), Long.valueOf(numOfComp), Integer.valueOf(nexCrop.ABSTRACT_DIMENSION)}));
    ...
    protected void readFullTagValue(ExifTag tag) throws IOException, ExifInvalidFormatException {
        ...
        if (componentCount < 0) {
            throw new ExifInvalidFormatException(String.format(Locale.US, "Invalid size [%d] of tag [%s]", new Object[]{Integer.valueOf(componentCount), tag}));
        }
        int[] value;
        int n;
        int i;
        ...
        switch (tag.getDataType()) {
            ...
            case (short) 3:
                ...
                return;
            case (short) 4:
                long[] value3 = new long[componentCount];
                n = value3.length;
                for (i = 0; i < n; i++) {
                ...
                return;
            case (short) 5:
                value2 = new Rational[componentCount];
                n = value2.length;
                for (i = 0; i < n; i++) {
