...
public class BrightnessManager implements BrightnessProvider {
    ...
    public void setTemporaryScreenAutoBrightnessAdjustmentRatio(float ratio) {
        MiscUtil.invokeSafely((PowerManager) getActivity().getSystemService("power"), "setTemporaryAutoBrightnessAdjustmentRatio", new Class[]{Float.TYPE}, Float.valueOf(ratio));
    }
