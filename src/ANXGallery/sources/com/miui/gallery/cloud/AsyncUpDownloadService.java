...
public class AsyncUpDownloadService extends Service {
    ...
    private class ForegroundRef extends ResourceRef {
        ...
        protected void onAcquire() {
            AsyncUpDownloadService.this.startForeground(4, new Notification());
    ...
    private class WakeLockRef extends ResourceRef {
        ...
        protected void onRelease() {
            if (this.mWakeLock != null) {
                ...
                GallerySamplingStatHelper.recordCountEvent("Sync", "sync_wakelock_time", params);
            }
        }
    ...
    public void onDestroy() {
        ...
        GallerySamplingStatHelper.recordCountEvent("Sync", "sync_service_time", params);
    }
