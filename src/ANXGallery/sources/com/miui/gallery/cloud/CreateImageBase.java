...
public abstract class CreateImageBase implements Operation {
    ...
    private void statCannotUpload(DBImage oldData, DBImage newData, boolean isInvalid) {
        ...
        GallerySamplingStatHelper.recordErrorEvent("Sync", "sync_cannot_upload", params);
        if (isInvalid) {
            params.clear();
            params.put("localFile", newData.getLocalFile());
            GallerySamplingStatHelper.recordErrorEvent("Sync", "sync_invalid_data", params);
        }
    }
    ...
    private void statImageCreate(File file, long cost) {
        ...
        GallerySamplingStatHelper.recordCountEvent("Sync", "sync_upload_time_one_photo", params);
        ...
        GallerySamplingStatHelper.recordCountEvent("Sync", "sync_upload_timely", params);
    }
    ...
    private boolean ensureExifAndSha1Valid(DBImage dbCloud) throws IOException {
        ...
        if (!(TextUtils.isEmpty(originalSha1) && TextUtils.isEmpty(originalFileName))) {
            ...
            GallerySamplingStatHelper.recordCountEvent("micloud_sync", "upload_thumbnail", params);
