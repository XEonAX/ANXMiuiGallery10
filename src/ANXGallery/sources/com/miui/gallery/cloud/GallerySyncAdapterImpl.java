...
public class GallerySyncAdapterImpl {
    ...
    private void statSpaceStatus() {
        ...
        GallerySamplingStatHelper.recordCountEvent("Sync", "sync_check_cloud_space", params);
    }
    ...
    private void recordSyncError(Throwable e) {
        if (e != null) {
            ...
            GallerySamplingStatHelper.recordErrorEvent("Sync", "sync_error_message", params);
        }
    }
