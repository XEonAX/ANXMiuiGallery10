...
public class SpaceFullHandler {
    ...
    public static synchronized void setSharerSpaceFull(String albumId) {
        synchronized (SpaceFullHandler.class) {
            Log.d("SpaceFullHandler", new Throwable().getStackTrace()[1].getClassName() + " set shareAlbum:" + albumId + " space full.");
    ...
    public static synchronized void removeSharerSpaceFull(String albumId) {
        synchronized (SpaceFullHandler.class) {
            Log.d("SpaceFullHandler", new Throwable().getStackTrace()[1].getClassName() + " remove shareAlbum:" + albumId + " space full.");
