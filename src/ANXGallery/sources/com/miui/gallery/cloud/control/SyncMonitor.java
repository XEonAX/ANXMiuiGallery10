    ...
    private static final class WorkHandler extends Handler {
            ...
            if (account != null && SyncUtil.isGalleryCloudSyncable(context) && !SyncStateUtil.isSyncing(context)) {
                ...
                if (!isPending) {
                    if (Preference.sIsFirstSynced()) {
                        dirty = SyncStateUtil.getDirtyCount(context);
        ...
        private static void statSyncInBackground() {
            ...
            if (speed > 0) {
                ...
                GallerySamplingStatHelper.recordCountEvent("sync_monitor", "monitor_background_predicted_time", params);
            }
        }
        ...
        private static void statPolicyChanged() {
            ...
            GallerySamplingStatHelper.recordCountEvent("sync_monitor", "monitor_sync_policy_changed_dirty", params);
        }
    }
