...
public class SyncOwnerFromLocal extends SyncFromLocalBase {
    ...
    protected String getSelectionClause() {
        ...
        if (MiscUtil.isValid(paths)) {
            ...
            sb.append(")");
            return DatabaseUtils.concatenateWhere(CloudUtils.SELECTION_OWNER_NEED_SYNC, sb.toString());
        }
        return String.format(" (%s) ", new Object[]{CloudUtils.SELECTION_OWNER_NEED_SYNC});
    }
