...
public class HomePageImmersionMenuHelper implements ImmersionMenuListener {
    ...
    private class FeatureInfo {
        ...
        public FeatureInfo(String featureName, boolean isUpdate, boolean isPushValid) {
            ...
            if (!FeatureRedDot.isUpdateFeatureStated(featureName)) {
                ...
                GallerySamplingStatHelper.recordCountEvent("feature_red_dot", "new_feature", param);
    ...
    public void onImmersionMenuSelected(ImmersionMenu menu, ImmersionMenuItem item) {
        if (this.mContext != null) {
            ...
            if (featureInfo != null) {
                ...
                GallerySamplingStatHelper.recordCountEvent("feature_red_dot", String.format(Locale.US, "%s_%s", new Object[]{"click_menu", featureInfo.mFeatureName}), param);
            }
            checkRedDotFeature();
            switch (itemId) {
                case R.id.menu_cleaner /*2131886092*/:
                    ...
                    return;
                case R.id.menu_collage /*2131886093*/:
                    ...
                    return;
                case R.id.menu_photo_movie /*2131886094*/:
                    ...
                    return;
                case R.id.menu_photo_print /*2131886095*/:
                    ...
                    return;
                case R.id.menu_settings /*2131886096*/:
                    IntentUtil.enterGallerySetting(this.mContext);
                    return;
                case R.id.trash_bin /*2131886119*/:
    ...
    public void showImmersionMenu(View anchor, String page) {
        ...
        Map param = new HashMap();
        param.put(String.format(Locale.US, "%s_redDotDisplayed", new Object[]{this.mCurrentPage}), Boolean.valueOf(this.mHasRedDotItem));
        GallerySamplingStatHelper.recordCountEvent("feature_red_dot", "show_immersion_menu", param);
    }
