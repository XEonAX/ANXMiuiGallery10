    ...
    private class ItemClickGestureListener extends SimpleOnGestureListener {
        ...
        public boolean onSingleTapUp(MotionEvent event) {
            ...
            if (tapView != null) {
                ...
                if (position != -1 && ClickItemTouchListener.this.performItemClick(this.mHostView, tapView, position, id)) {
                    handled = true;
                }
                if (handled) {
        ...
        public void onLongPress(MotionEvent event) {
            ...
            if (longPressedView != null) {
                ...
                boolean handled = position != -1 && ClickItemTouchListener.this.performItemLongClick(this.mHostView, longPressedView, position, this.mHostView.getAdapter().getItemId(position));
                if (handled) {
                    this.mIsTapUpConsumed = true;
                }
            }
