...
public class GalleryPreferences {
    ...
    public static class CTA {
        ...
        public static void setCanConnectNetwork(boolean remindNever) {
            ...
            LocalBroadcastManager.getInstance(GalleryApp.sGetAndroidContext()).sendBroadcast(new Intent("com.miui.gallery.action.CTA_CHANGED"));
        }

        public static boolean canConnectNetwork() {
            return PreferenceHelper.getBoolean(PrefKeys.CTA_CAN_CONNECT_NETWORK_BY_IMPUNITY, Preference.sCanConnectNetworkByImpunity()) || sCanConnectToNetworkTemp;
        }
        ...
        public static void onCreateOrDestroyHomePage() {
            if (sAllowUseOnOfflineGlobal) {
                sAllowUseOnOfflineGlobal = false;
            }
        ...
        public static void setIsCtaPrivacyPermissionsAllowed(String permission, boolean isAllowed) {
            PreferenceHelper.putBoolean(PrefKeys.CTA_PRIVACY_PERMISSIONS_ALLOWED + permission, isAllowed);
        }

        public static boolean getIsCtaPrivacyPermissionsAllowed(String permission) {
    ...
    public static class DocumentProvider {
        ...
        public static int getOpenExternalDocumentCount() {
            return PreferenceHelper.getInt(PrefKeys.DOCUMENT_PROVIDER_ACCESS_INTENT_COUNT_PREFIX + StorageUtils.getSecondaryStoragePath(), 0);
        }

        public static void setOpenExternalDocumentCount(int i) {
            PreferenceHelper.putInt(PrefKeys.DOCUMENT_PROVIDER_ACCESS_INTENT_COUNT_PREFIX + StorageUtils.getSecondaryStoragePath(), i);
        }

        public static boolean isFirstEntrance() {
            return PreferenceHelper.getBoolean(PrefKeys.DOCUMENT_PROVIDER_FIRST_ENTRANCE_SDCARD_PERMISSION_PREFIX + StorageUtils.getSecondaryStoragePath(), true);
        }

        public static void setFirstEntrance(boolean isFirstEntrance) {
            PreferenceHelper.putBoolean(PrefKeys.DOCUMENT_PROVIDER_FIRST_ENTRANCE_SDCARD_PERMISSION_PREFIX + StorageUtils.getSecondaryStoragePath(), isFirstEntrance);
        }
    }
    ...
    public static class FeatureGuidance {
        public static boolean hasEverUsed(String feature) {
            return PreferenceHelper.getBoolean(String.format(Locale.US, PrefKeys.FEATURE_EVER_USED_FORMATTER, new Object[]{feature}), false);
        }

        public static void markAsUsed(String feature) {
            if (!TextUtils.isEmpty(feature)) {
                PreferenceHelper.putBoolean(String.format(Locale.US, PrefKeys.FEATURE_EVER_USED_FORMATTER, new Object[]{feature}), true);
            }
        }
    }
    ...
    public static class FileDownload {
        ...
        public static int clampConnTimeout(int timeout) {
            return MiscUtil.clamp(timeout, 5000, 30000);
        }
    }
    ...
    public interface PrefKeys {
        ...
        public static final String DOCUMENT_PROVIDER_ACCESS_INTENT_COUNT_PREFIX = "document_provider_access_intent_count_";
        public static final String DOCUMENT_PROVIDER_FIRST_ENTRANCE_SDCARD_PERMISSION_PREFIX = "document_provider_first_entrance_sdcard_permission_";
