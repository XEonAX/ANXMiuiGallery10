    ...
    class ScanResultHolder extends ViewHolder implements OnClickListener {
        ...
        public void bindData(ScanResult result, boolean isLast) {
            ...
            if (result.getCount() > 0) {
                String count = ScanResultAdapter.this.mContext.getResources().getQuantityString(R.plurals.file_count_format, result.getCount(), new Object[]{Integer.valueOf(result.getCount())});
                this.mCount.setVisibility(0);
                this.mCount.setText(count);
            } else {
