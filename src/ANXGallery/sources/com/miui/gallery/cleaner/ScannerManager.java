    ...
    private FutureHandler mScanFutureHandler = new FutureHandler<Void>() {
        public void onPostExecute(Future<Void> future) {
            if (!future.isCancelled()) {
                ...
                params.put("timeCost", GallerySamplingStatHelper.formatValueStage((float) ((int) ((System.currentTimeMillis() - ScannerManager.this.mScanStartTime) / 1000)), ScannerManager.TIME_COST_STAGE));
                GallerySamplingStatHelper.recordCountEvent("cleaner", "cleaner_scan_finish", params);
            }
        }
    };
