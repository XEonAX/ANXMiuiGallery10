        ...
        private static class Multiple extends Decor {
            ...
            public void applyActionBar() {
                ...
                if (BuildUtil.isInternational()) {
                    this.mTitle.setTextAppearance(this.mActivity, R.style.f47Gallery.TextAppearance.InternationalPickerTitle);
                } else {
                    this.mTitle.setTypeface(Typeface.MONOSPACE);
                }
                titleView.findViewById(EditActionMode.BUTTON1).setOnClickListener(new OnClickListener() {
