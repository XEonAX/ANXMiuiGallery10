...
public class PickHomePageFragment extends PickerFragment {
    ...
    private class HomePagePhotoLoaderCallback implements LoaderCallbacks {
        ...
        public Loader onCreateLoader(int i, Bundle bundle) {
            ...
            loader.setProjection(HomePageAdapter.PROJECTION);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.mHomePageAdapter = new PickableBaseTimeLineAdapterWrapper(this.mPicker, new HomePageAdapter(this.mActivity, SyncStateShowScene.SCENE_NONE));
    }
