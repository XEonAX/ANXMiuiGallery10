...
public class MovieDownloadManager {
    ...
    private void downloadResource(final MovieResource data, final MovieDownloadListener downloadListener, boolean isActiveNetworkMetered) {
