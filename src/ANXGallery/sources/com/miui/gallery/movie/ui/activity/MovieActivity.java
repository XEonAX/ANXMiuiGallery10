...
public class MovieActivity extends BaseActivity implements OnClickListener, MenuFragmentListener {
    ...
    private SingleClickListener mSingleClickListener = new SingleClickListener() {
        protected void onSingleClick(View v) {
            switch (v.getId()) {
                case R.id.movie_title /*2131886542*/:
                    MovieActivity.this.finish();
                    return;
                case R.id.movie_share /*2131886543*/:
    ...
    public void onCreate(Bundle savedInstanceState) {
        setTheme(R.style.f162GalleryTheme.MovieTheme);
        if (parseIntent()) {
    ...
    private void initView() {
        ...
        this.mMovieView.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                } else if (MovieActivity.this.isEditorPreview) {
    ...
    private void initMovieViewLayout() {
        ...
        int height = (int) (((((float) fullScreenHeight) - getResources().getDimension(R.dimen.movie_controller_height)) - (2.0f * getResources().getDimension(R.dimen.movie_editor_vertical_margin))) - ((float) notchHeight));
        ...
        this.mEditorMovieLps.topMargin = ((int) getResources().getDimension(R.dimen.movie_editor_vertical_margin)) + notchHeight;
    ...
    private boolean parseIntent() {
        List<ImageEntity> imagePaths = MovieUtils.getImageFromClipData(this, getIntent());
    ...
    public void changeEditor() {
        if (this.mShowMode == 3) {
            this.mShowMode = 2;
            getFragmentManager().beginTransaction().hide(this.mEditorMenuFragment).show(this.mPreviewMenuFragment).commit();
    ...
    private void doShare(String outFilePath) {
        ...
        if (MiscUtil.isValid(resInfoList)) {
