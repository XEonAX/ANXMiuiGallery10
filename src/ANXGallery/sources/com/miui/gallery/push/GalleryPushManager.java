...
public class GalleryPushManager {
    ...
    private void subscribeTopics(Context context, boolean unsubscribeOthers, String... topics) {
        if (context != null) {
            ...
            if (topics != null && topics.length != 0) {
                ...
                if (MiscUtil.isValid(subscribedTopics)) {
            ...
            } else if (unsubscribeOthers && MiscUtil.isValid(subscribedTopics)) {
    ...
    private void setUserAccount(Context context, String userAccount, boolean unsetOthers) {
        ...
        if (MiscUtil.isValid(registeredAccounts)) {
    ...
    public void registerPush(Context context) {
        if (PrivacyAgreementUtils.isGalleryAgreementEnable(context)) {
            if (!CTA.canConnectNetwork() && BuildUtil.isInternational()) {
                CTA.setCanConnectNetwork(true);
            }
            if (CTA.canConnectNetwork() && shouldInit(context)) {
