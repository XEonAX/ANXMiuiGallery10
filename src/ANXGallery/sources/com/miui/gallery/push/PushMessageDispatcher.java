    ...
    public static void dispatch(Context context, MiPushMessage message) {
        ...
        if (messageScope == MessageScope.RELEASE || (messageScope == MessageScope.DEBUG && Rom.IS_DEBUGGABLE)) {
            ...
            if (messageType == null) {
                ...
                GallerySamplingStatHelper.recordErrorEvent("mipush", "unknown_message_type", params);
                return;
            }
            ...
            GallerySamplingStatHelper.recordErrorEvent("mipush", "push_user_account_doesnt_match", params2);
            return;
        }
        ...
        GallerySamplingStatHelper.recordErrorEvent("mipush", "unknown_message_scope_doesnt_match", params);
    }
}
