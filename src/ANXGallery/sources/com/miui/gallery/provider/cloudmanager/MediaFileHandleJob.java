    ...
    public void doDelete(Context context, boolean local) {
        ...
        if (!TextUtils.isEmpty(this.mLocalFile)) {
            ...
            if (lastModify > 0 && interval < 60) {
                ...
                GallerySamplingStatHelper.recordCountEvent("Sync", "sync_photo_delete_in_one_minute", params);
                GallerySamplingStatHelper.recordNumericPropertyEvent("Sync", "sync_photo_delete_interval", interval);
            }
        }
    }
