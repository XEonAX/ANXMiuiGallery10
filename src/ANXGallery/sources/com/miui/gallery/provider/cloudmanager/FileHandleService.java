...
public class FileHandleService extends Service implements FileHandleListener {
        ...
        public void handleMessage(Message msg) {
            ...
            if ("check_unhandled_media_ids".equals(action)) {
                ...
                if (ids != null && ids.length > 0) {
                    ...
                    GallerySamplingStatHelper.recordCountEvent("file_handle", "restore_unhandled_file_operations", params);
                }
