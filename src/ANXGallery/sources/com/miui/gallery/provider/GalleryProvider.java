    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String orderBy) {
        ...
        switch (matchResult) {
            case 50:
                ...
                cursor = AlbumManager.query(getContext(), db, projection, selection, selectionArgs, orderBy, joinVideo, joinFace, joinShare, joinPano, joinRecent, joinFavorites, excludeEmptyAlbum, queryAllExistAlbum, uri.getBooleanQueryParameter("remove_duplicate_items", false), mediaTypeString == null ? null : Integer.valueOf(mediaTypeString));
                z = false;
                break;
            case 51:
            case 65:
                ...
                try {
                    ...
                    if (id == -1) {
                        ...
                        if (id != -1) {
                            ...
                            ImageFeatureManger.getInstance().recordNewImage(id, values);
                        }
                    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (matchResult) {
            ...
            case BaiduSceneResult.BASKETBALL /*85*/:
                ...
                if (count > 0) {
                    for (String sha1 : getSha1ListFromFavorites(selection, selectionArgs, true)) {
