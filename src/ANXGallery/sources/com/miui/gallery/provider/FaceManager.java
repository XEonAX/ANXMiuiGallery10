...
public class FaceManager {
    ...
    private static final String[] SQL_FACE_ALBUM_COVER_PROJECTION = new String[]{" CASE WHEN " + Cloud.ALIAS_THUMBNAIL_VALID + " THEN " + "thumbnailFile" + " " + "WHEN " + Cloud.ALIAS_ORIGIN_FILE_VALID + " THEN " + "localFile" + " " + "ELSE " + "microthumbfile" + " " + "END AS " + "cover_path" + ", " + "exifOrientation" + ", " + "faceXScale" + ", " + "faceYScale" + ", " + "faceWScale" + ", " + "faceHScale" + ", " + "serverId"};
    ...
    public static String buildOnePersonQuery(String[] projection, String selection, String orderBy, String serverIdOfPerson, String localIdOfPeople) {
        return buildAlbumQuery(projection, selection, null, "mixedDateTime DESC", String.format(Locale.US, SQL_ONE_PERSON_ALBUM_NORMAL, new Object[]{serverIdOfPerson, localIdOfPeople}));
    }
    ...
    public static String queryCoverImageOfOnePerson(String peopleServerId, RectF[] resultFaceRegion) {
        ...
        try {
            cursor = GalleryApp.sGetAndroidContext().getContentResolver().query(PeopleFace.ONE_PERSON_URI, SQL_FACE_ALBUM_COVER_PROJECTION, null, new String[]{peopleServerId, "-1"}, "dateTaken DESC ");
