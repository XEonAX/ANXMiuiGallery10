...
public class PeopleCoverManager {
    ...
    private void statPeopleCover(float averageScore, int successCount) {
        GallerySamplingStatHelper.recordNumericPropertyEvent("people", "people_cover_score", (long) GallerySamplingStatHelper.generatorValueStage(averageScore, SCORE_STAGE));
        GallerySamplingStatHelper.recordNumericPropertyEvent("people", "people_cover_success_count", (long) successCount);
    }
