    ...
    public void load(SQLiteDatabase db) {
        synchronized (INITIALIZATION_LOCK) {
            ...
            try {
                ...
                Map<String, String> recordParams = GallerySamplingStatHelper.generatorCommonParams();
                recordParams.put("dbversion", String.valueOf(db.getVersion()));
                recordParams.put("exception", e.getMessage() + " : " + e.getCause());
                GallerySamplingStatHelper.recordErrorEvent("db_helper", "db_mediamanager_load", recordParams);
