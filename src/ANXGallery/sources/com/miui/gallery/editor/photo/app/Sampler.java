...
public class Sampler {
    ...
    public void recordEvent(String category, String event, Map<String, String> params) {
        ...
        GallerySamplingStatHelper.recordCountEvent(String.format(Locale.US, this.mFormat, new Object[]{category}), event, params);
    }

    public void recordEvent(String category, String event) {
        Log.d("Sampler", "record cat: %s, event: %s", category, event);
        GallerySamplingStatHelper.recordCountEvent(String.format(Locale.US, this.mFormat, new Object[]{category}), event);
    }
    ...
    public void recordNumericEvent(String category, String event, long params) {
        ...
        GallerySamplingStatHelper.recordNumericPropertyEvent(String.format(Locale.US, this.mFormat, new Object[]{category}), event, params);
    }
