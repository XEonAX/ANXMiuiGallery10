...
public class TextEditDialog extends GalleryDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        Dialog dialog = new Dialog(getActivity(), R.style.f174PhotoEditor.Dialog.TextDialog);
        ...
        if (window != null) {
            ...
            window.getAttributes().windowAnimations = R.style.f174PhotoEditor.Dialog.TextDialog;
        }
        return dialog;
    }
    ...
    public void setInitializeData(TextStatusData initializeData) {
