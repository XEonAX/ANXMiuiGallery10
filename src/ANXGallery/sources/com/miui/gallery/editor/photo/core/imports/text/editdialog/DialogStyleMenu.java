...
class DialogStyleMenu extends DialogSubMenu<ConfigChangeListener, TextStatusData> implements OnClickListener, OnSeekBarChangeListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.text_edit_dialog_tab_style_shadow /*2131886738*/:
                ...
                return;
            case R.id.text_edit_dialog_tab_style_align /*2131886739*/:
                ...
                return;
            case R.id.text_edit_dialog_tab_style_bold /*2131886740*/:
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        switch (seekBar.getId()) {
            case R.id.text_edit_dialog_tab_style_transparent /*2131886737*/:
                if (this.mListener != null) {
