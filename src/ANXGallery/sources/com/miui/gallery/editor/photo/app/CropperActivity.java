            ...
            try {
                ...
                if (in != null) {
                    ...
                    try {
                        ...
                        exif.readExif(in2);
                        ExifTag orientation = exif.getTag(ExifInterface.TAG_ORIENTATION);
                        if (orientation != null) {
                            i = ExifInterface.getRotationForOrientationValue((short) orientation.getValueAsInt(0));
                            if (in2 != null) {
                                try {
                                    in2.close();
                                } catch (Throwable e2) {
