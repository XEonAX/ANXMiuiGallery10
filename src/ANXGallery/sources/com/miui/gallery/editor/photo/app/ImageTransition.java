...
class ImageTransition extends ChangeBounds {
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        if (!this.mEnter) {
            ...
            scaleChanged = !MiscUtil.floatNear((1.0f * ((float) this.mImageWidth)) / ((float) this.mImageHeight), (1.0f * ((float) drawable.getIntrinsicWidth())) / ((float) drawable.getIntrinsicHeight()), 0.01f);
        }
        if (scaleChanged) {
