...
public class FilterManager {
    static List<FilterCategoryData> getFilterCategory() {
        ...
        if (BuildUtil.isInternational() && Settings.getRegion().endsWith("IN")) {
            categoryData.add(new FilterCategoryData(5, GalleryApp.sGetAndroidContext().getString(R.string.filter_category_portrait), GalleryApp.sGetAndroidContext().getResources().getColor(R.color.filter_category_people_india)));
        } else {
            categoryData.add(new FilterCategoryData(2, GalleryApp.sGetAndroidContext().getString(R.string.filter_category_portrait), GalleryApp.sGetAndroidContext().getResources().getColor(R.color.filter_category_people)));
        }
    ...
    private static ArrayList<FilterItem> getPortraitFilterItem() {
        ...
        filters.add(new FilterItem("filter/beauty/romance.png", GalleryApp.sGetAndroidContext().getString(R.string.filter_people_roman), R.drawable.filter_people_roman, 70));
        filters.add(new FilterItem("filter/beauty/heart.png", GalleryApp.sGetAndroidContext().getString(R.string.filter_people_heart), R.drawable.filter_people_heart, 100));
        ...
        filters.add(new FilterItem("filter/beauty/mint.png", GalleryApp.sGetAndroidContext().getString(R.string.filter_people_mint), R.drawable.filter_people_mint, 100));
    ...
    private static ArrayList<FilterItem> getPortraitIndiaFilterItem() {
        ...
        filters.add(new FilterItem("filter/beauty_india/sweet.png", GalleryApp.sGetAndroidContext().getString(R.string.filter_bi_sweet), R.drawable.portait_effect_image_sweet, 70));
        filters.add(new FilterItem("filter/beauty_india/portrait.png", GalleryApp.sGetAndroidContext().getString(R.string.filter_bi_portrait), R.drawable.portait_effect_image_portrait, 100));
        ...
        filters.add(new FilterItem("filter/beauty_india/young.png", GalleryApp.sGetAndroidContext().getString(R.string.filter_bi_young), R.drawable.portait_effect_image_young, 100));
        ...
        filters.add(new FilterItem("filter/beauty_india/mono.png", GalleryApp.sGetAndroidContext().getString(R.string.filter_bi_mono), R.drawable.portait_effect_image_mono, 100));
        return filters;
    }
