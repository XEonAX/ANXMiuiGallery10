...
public class NexVideoEditor extends VideoEditor implements nexEngineListener {
    ...
    private DisplayAspectRatio mCurrentRatio = DisplayAspectRatio.A16V9;
    ...
    private class BGMEdit implements Change {
        ...
        public void applyChange() {
            ...
            if (!new File(this.mBGMUri).exists()) {
                ...
                GallerySamplingStatHelper.recordCountEvent("video_editor", "video_editor_bgm_empty_file_error", params);
            }
        }
    }
    ...
    private class TextClip implements Change {
        private int Mode_16v9_Height;
        private int Mode_16v9_Width;
        private int Mode_1v1_Height;
        private int Mode_1v1_Width;
        private int Mode_2v1_Height;
        private int Mode_2v1_Width;
        private int Mode_4v3_Height;
        private int Mode_4v3_Width;
        ...
        private TextClip() {
            this.mShowTime = 0;
            this.Mode_16v9_Width = 1280;
            this.Mode_16v9_Height = 720;
            this.Mode_1v1_Width = 720;
            this.Mode_1v1_Height = 720;
            this.Mode_2v1_Width = 1440;
            this.Mode_2v1_Height = 720;
            this.Mode_4v3_Width = 960;
            this.Mode_4v3_Height = 720;
        }
        ...
        private void initXY() {
            switch (nexApplicationConfig.getAspectMode()) {
                case 1:
                    this.x = this.Mode_16v9_Width / 2;
                    this.y = this.Mode_16v9_Height / 2;
                    return;
                case 2:
                    this.x = this.Mode_1v1_Width / 2;
                    this.y = this.Mode_1v1_Height / 2;
                    return;
                case 3:
                    this.y = this.Mode_16v9_Width / 2;
                    this.x = this.Mode_16v9_Height / 2;
                    return;
                case 4:
                    this.x = this.Mode_2v1_Width / 2;
                    this.y = this.Mode_2v1_Height / 2;
                    return;
                case 5:
                    this.x = this.Mode_2v1_Height / 2;
                    this.y = this.Mode_2v1_Width / 2;
                    return;
                case 6:
                    this.x = this.Mode_4v3_Width / 2;
                    this.y = this.Mode_4v3_Height / 2;
                    return;
                case 7:
                    this.x = this.Mode_4v3_Height / 2;
                    this.y = this.Mode_4v3_Width / 2;
                    return;
                default:
                    this.x = NexVideoEditor.this.mVideoWidth / 2;
                    this.y = NexVideoEditor.this.mVideoHeight / 2;
                    return;
            }
        }
    ...
    class WaterMark implements Change {
        private int Mode_16v9_Height = 720;
        private int Mode_16v9_Width = 1280;
        private int Mode_1v1_Height = 720;
        private int Mode_1v1_Width = 720;
        private int Mode_2v1_Height = 720;
        private int Mode_2v1_Width = 1440;
        private int Mode_4v3_Height = 720;
        private int Mode_4v3_Width = 960;
        ...
        private void initCommon() {
            switch (nexApplicationConfig.getAspectMode()) {
                case 1:
                    this.x = this.Mode_16v9_Width / 2;
                    this.y = this.Mode_16v9_Height / 2;
                    this.scale = 970.0f / ((float) this.Mode_16v9_Width);
                    break;
                case 2:
                    this.x = this.Mode_1v1_Width / 2;
                    this.scWidth = (float) this.Mode_1v1_Width;
                    this.y = this.Mode_1v1_Height / 2;
                    this.scale = ((float) this.Mode_1v1_Height) / 1250.0f;
                    break;
                case 3:
                    this.y = this.Mode_16v9_Width / 2;
                    this.x = this.Mode_16v9_Height / 2;
                    this.scWidth = (float) this.Mode_16v9_Height;
                    this.scale = ((float) this.Mode_16v9_Height) / 1250.0f;
                    break;
                case 4:
                    this.x = this.Mode_2v1_Width / 2;
                    this.y = this.Mode_2v1_Height / 2;
                    this.scale = 970.0f / ((float) this.Mode_2v1_Width);
                    break;
                case 5:
                    this.x = this.Mode_2v1_Height / 2;
                    this.scWidth = (float) this.Mode_2v1_Width;
                    this.y = this.Mode_2v1_Width / 2;
                    this.scale = ((float) this.Mode_2v1_Height) / 1250.0f;
                    break;
                case 6:
                    this.x = this.Mode_4v3_Width / 2;
                    this.y = this.Mode_4v3_Height / 2;
                    this.scale = 970.0f / ((float) this.Mode_4v3_Width);
                    break;
                case 7:
                    this.x = this.Mode_4v3_Height / 2;
                    this.scWidth = (float) this.Mode_4v3_Width;
                    this.y = this.Mode_4v3_Width / 2;
                    this.scale = ((float) this.Mode_4v3_Height) / 1250.0f;
                    break;
                default:
                    this.x = NexVideoEditor.this.mVideoWidth / 2;
                    this.y = NexVideoEditor.this.mVideoHeight / 2;
            ...
            if (NexVideoEditor.this.getProjectTotalTime() < this.mAlphaDurationTime) {
                ToastUtils.makeText(NexVideoEditor.this.mContext, (int) R.string.video_editor_video_is_short);
            }
        }
            ...
            public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
                if (loadedImage != null) {
                    ...
                    if (NexVideoEditor.this.preLoadVideoThumbnails.size() == 0) {
                        switch (VideoEditor.getBestVideoAspect(loadedImage.getWidth(), loadedImage.getHeight(), 0)) {
                            case A16V9:
                ...
                try {
                    ...
                    new AsyncTask<Void, Void, Boolean>() {
                        protected Boolean doInBackground(Void... params) {
                            try {
                                NexVideoEditor.this.handleHardwareSupport(str);
                    ...
                    params.put("manufacturer", Build.MANUFACTURER);
                    params.put("model", Build.MODEL);
                    GallerySamplingStatHelper.recordCountEvent("video_editor", "video_editor_sdk_init_error", params);
                }
            }
        });
    }
    ...
    private void loadThumbnail(final OnCompletedListener listener) {
        int thumbnailWidth;
        int thumbnailHeight;
        if (this.mCurrentRatio == DisplayAspectRatio.A16V9) {
            thumbnailWidth = 160;
        } else {
            thumbnailWidth = 90;
        }
    ...
    private void configEngine() {
        DisplayAspectRatio ratio = VideoEditor.getBestVideoAspect(this.mVideoWidth, this.mVideoHeight, this.mVideoRotation);
        if (this.mCurrentRatio != ratio) {
            switch (ratio) {
                case A16V9:
                    nexApplicationConfig.setAspectMode(1);
                    Log.d("NexVideoEditor", "current ratio  is  A16V9");
                    break;
                case A9V16:
                    nexApplicationConfig.setAspectMode(3);
                    Log.d("NexVideoEditor", "current ratio  is  A9V16");
                    break;
                case A9V18:
                    nexApplicationConfig.setAspectMode(5);
                    Log.d("NexVideoEditor", "current ratio  is  A9V18");
                    break;
                case A18V9:
                    nexApplicationConfig.setAspectMode(4);
                    Log.d("NexVideoEditor", "current ratio  is  A18V9");
                    break;
                case A3V4:
                    nexApplicationConfig.setAspectMode(7);
                    Log.d("NexVideoEditor", "current ratio  is  A3V4");
                    break;
                case A4V3:
                    nexApplicationConfig.setAspectMode(6);
                    Log.d("NexVideoEditor", "current ratio  is  A4V3");
                    break;
                case A1V1:
                    nexApplicationConfig.setAspectMode(2);
                    Log.d("NexVideoEditor", "current ratio  is  A1V1");
                    break;
            }
    ...
    private void handleHardwareSupport(String path) throws NotSupportVideoException {
        if (!ToolsUtil.isSupportEditVideo(path)) {
                        ...
                        NexVideoEditor.this.mHandler.post(new Runnable() {
                            public void run() {
                                NexVideoEditor.this.export(outPutFilePath, new EnocdeStateInterface() {
                                    ...
                                    public void onEncodeEnd(boolean success, int errorCode) {
                                        if (success) {
                                            NexVideoEditor.this.mHasUsingAutoTrim = true;
                                        }
                                        if (NexVideoEditor.this.mTrimStateInterface != null) {
                                            NexVideoEditor.this.mTrimStateInterface.onEncodeEnd(success, errorCode);
                                        }
                                    }
                                });
                            }
    ...
    public void onEncodingDone(boolean b, int i) {
        if (this.mCurrentEnocdeStateInterface != null) {
            ...
            enocdeStateInterface.onEncodeEnd(z, i);
        }
        setEngineState(0);
        ...
        if (this.mApplyedEditValue.size() > 0) {
            ...
            GallerySamplingStatHelper.recordCountEvent("video_editor", "video_editor_using_effect", params);
        }
    }
    ...
    public void onPlayFail(int err, int iClipID) {
        ...
        GallerySamplingStatHelper.recordCountEvent("video_editor", "video_editor_play_failed", params);
        switch (this.mEngineState) {
            case BaiduSceneResult.TEMPLE /*105*/:
                if (this.mCurrentEnocdeStateInterface != null) {
