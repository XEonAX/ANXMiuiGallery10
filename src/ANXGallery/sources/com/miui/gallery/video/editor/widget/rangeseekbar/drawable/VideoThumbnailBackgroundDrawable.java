...
import com.miui.gallery.video.editor.DisplayAspectRatio;

public class VideoThumbnailBackgroundDrawable extends Drawable {
    private DisplayAspectRatio mAspectRatio = DisplayAspectRatio.A16V9;
    ...
    public void setAspectRatio(DisplayAspectRatio aspectRatio) {
    ...
    public void draw(Canvas canvas) {
        if (this.mBitmapProvider != null) {
            ...
            int itemWidth = (int) (((float) ((this.mBounds.height() - this.mPadding.top) - this.mPadding.bottom)) * this.mAspectRatio.getRatio());
            int i;
            Bitmap bitmap;
