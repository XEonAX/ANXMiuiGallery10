...
public class VideoEditorHelper {
    ...
    public void onSave() {
        ...
        EncodeProgressDialog.startEncode(this.mVideoEditor, FileHelper.generateOutputFilePath(data.getPath(), false), new OnCompletedListener() {
            public void onCompleted(String outputPath, boolean success, String msg) {
                if (success) {
                    Log.d("VideoEditorHelper", "video save success. ");
                ...
                params.put("errormsg", String.valueOf(msg));
                GallerySamplingStatHelper.recordCountEvent("video_editor", "video_editor_export_failed", params);
                ...
                Log.e("VideoEditorHelper", "video save fail, and video encode error  msg : " + msg);
