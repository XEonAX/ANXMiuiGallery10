...
public class WaterMarkFragment extends MenuFragment implements OnClickListener {
    ...
    private OnGlobalLayoutListener mOnGlobalLayoutListener = new OnGlobalLayoutListener() {
        public void onGlobalLayout() {
            ...
            int keyboardHeight = ScreenUtils.getExactScreenHeight(WaterMarkFragment.this.getActivity()) - WaterMarkFragment.this.mTextRoot.getRootView().getHeight();
            ...
            if (keyboardHeight == 0 && WaterMarkFragment.this.mIsKeyboardShowing) {
                ...
                WaterMarkFragment.this.mIsKeyboardShowing = false;
    ...
    private void initRecylerView(View view) {
        ...
        this.mAdapter.setmItemSelectChangeListener(new MyTextItemSelectChangeListener(this, null));
    ...
    private void dismissTextPopWindow() {
        Log.d("WaterMarkFragment", "dismiss textPopWindow!");
        this.mTextPopWindow.dismiss();
    ...
    private boolean updateEffectInfo() {
