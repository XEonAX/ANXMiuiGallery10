...
public class SmarttEffectRecyclerViewAdapter extends SingleChoiceRecyclerViewAdapter<SmartEffectViewHolder> {
    private int mFirstMarginLeft = 0;
    private LayoutInflater mLayoutInflater;
    private List<SmartEffect> smartEffectList;

    public SmarttEffectRecyclerViewAdapter(Context context, List<SmartEffect> smartEffects) {
