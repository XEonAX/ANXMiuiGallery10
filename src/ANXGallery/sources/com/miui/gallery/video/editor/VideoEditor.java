...
public abstract class VideoEditor {
    ...
    public abstract DisplayAspectRatio getCurrentDisplayRatio();
    ...
    public static DisplayAspectRatio getBestVideoAspect(int width, int height, int rotation) {
        return DisplayAspectRatio.getVideoAspectRatio(width, height, rotation);
    }
