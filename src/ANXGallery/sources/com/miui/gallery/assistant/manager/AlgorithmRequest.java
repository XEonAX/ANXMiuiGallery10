...
public abstract class AlgorithmRequest<T extends AlgorithmResult> implements Comparable<AlgorithmRequest>, Runnable {
    ...
    private void recordAlgorithmProcessTime(long start) {
        ...
        GallerySamplingStatHelper.recordCountEvent("assistant", "assistant_algorithm_process_time_" + this.TAG, params);
        GallerySamplingStatHelper.recordNumericPropertyEvent("assistant", "assistant_algorithm_process_time_distribution_" + this.TAG, elapseTime);
    }
