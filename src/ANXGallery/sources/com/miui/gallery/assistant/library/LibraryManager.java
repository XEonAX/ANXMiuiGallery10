...
public class LibraryManager {
            ...
            if (library == null) {
                ...
                downloadLibrary(library, false, new DownloadListener() {
                    public void onDownloadResult(long libraryId, int resultCode) {
                        ...
                        if (LibraryManager.this.isLibrarysExist(LibraryConstants.sStoryLibraries)) {
    ...
    boolean isLibrarysExist(Long[] ids) {
    ...
    private void recordDownloadResult(Library library, String result) {
        if (library != null) {
            GallerySamplingStatHelper.recordStringPropertyEvent("assistant", "library_download_result", library.getLibraryId() + "-" + result);
        }
    }
