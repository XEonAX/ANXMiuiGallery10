...
public class SearchFeedbackLikelyResultFragment extends SearchImageResultFragmentBase implements OnClickListener {
    ...
    protected void onInflateView(View view, Bundle savedInstanceState, Uri intentUri) {
        ...
        this.mGridView.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                GallerySamplingStatHelper.recordNumericPropertyEvent(SearchFeedbackLikelyResultFragment.this.getPageName(), "click_micro_thumb", (long) position);
            }
        });
    ...
    public void onClick(View v) {
        if (v != null) {
            switch (v.getId()) {
                case R.id.home_arrow /*2131886281*/:
                    finish();
                    return;
                case R.id.select_mode_button /*2131886664*/:
                    toggleSelectAll();
                    return;
                case R.id.report_button /*2131886680*/:
                    report();
                    return;
                default:
                    return;
    ...
    private void updateReportButtonState() {
        ...
        this.mSelectAllBtn.setText(isCheckedAll() ? R.string.custom_select_title_deselect_all : R.string.custom_select_title_select_all);
    }
