...
public class AppScreenshotSource extends LocalCacheBackedSuggestionSource<List<Pair<String, Suggestion>>> {
    ...
    private Long getScreenshotAlbumId() {
        return (Long) SafeDBUtil.safeQuery(this.mContext, Album.URI, new String[]{"_id"}, "serverId=?", new String[]{String.valueOf(2)}, null, new QueryHandler<Long>() {
