...
public interface AlbumConstants {
    public static final String[] PROJECTION = new String[]{"_id", "name", "cover_id", "cover_path", "cover_sha1", "cover_sync_state", "media_count", "face_people_id", "baby_info", "thumbnail_info", "serverId", "attributes", "album_unwriteable", "top_time", "sortBy", "baby_sharer_info", "local_path", Cloud.ALIAS_ALBUM_CLASSIFICATION + " AS " + "classification", "cover_size"};
