...
public class CleanerFragment extends BaseFragment {
    ...
    public boolean onBackPressed() {
        if (this.mProgressBar.isRotating() || this.mScannerManager.isScanning()) {
            ...
            params.put("durationBeforeExit", GallerySamplingStatHelper.formatValueStage((float) ((int) ((System.currentTimeMillis() - this.mScannerManager.getStartTime()) / 1000)), ScannerManager.TIME_COST_STAGE));
            GallerySamplingStatHelper.recordCountEvent("cleaner", "cleaner_scan_exit", params);
        } else {
            onExit();
        }
        return true;
    ...
    protected int getThemeRes() {
        return R.style.f165GalleryTheme.NoActionBar.DarkStatusBar;
    }
}
