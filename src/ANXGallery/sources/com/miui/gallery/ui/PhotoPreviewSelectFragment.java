...
public class PhotoPreviewSelectFragment extends PhotoPageFragmentBase {
    ...
    private class ChoiceManager extends ChoiceManagerBase implements OnClickListener {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.select_mode_button1 /*2131886395*/:
                    PhotoPreviewSelectFragment.this.finish();
                    break;
                case R.id.select_mode_button2 /*2131886397*/:
                    break;
                default:
                    return;
            }
        ...
        protected void updateSelectMode() {
            ...
            if (size <= 0 || size != this.mChoiceMode.getCount()) {
                this.mSelectAllBtn.setText(PhotoPreviewSelectFragment.this.getResources().getString(R.string.custom_select_title_select_all));
            } else {
                this.mSelectAllBtn.setText(PhotoPreviewSelectFragment.this.getResources().getString(R.string.custom_select_title_deselect_all));
            }
