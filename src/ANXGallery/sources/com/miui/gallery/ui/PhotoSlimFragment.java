...
public class PhotoSlimFragment extends BaseFragment implements SpaceSlimObserver {
    ...
    public boolean onBackPressed() {
        if (this.mSlimController.isSlimming()) {
            ...
            params.put("durationBeforeExit", GallerySamplingStatHelper.formatValueStage((float) ((int) ((System.currentTimeMillis() - this.mSlimController.getStartTime()) / 1000)), SlimController.TIME_COST_STAGE));
            GallerySamplingStatHelper.recordCountEvent("cleaner", "slim_exit", params);
        } else {
            onExit();
        }
        return true;
