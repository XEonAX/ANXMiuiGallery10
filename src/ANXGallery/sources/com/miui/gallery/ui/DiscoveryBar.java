...
public class DiscoveryBar extends HomePageBar implements OnClickListener {
    ...
    private void recordMessageClickStatus() {
        if (this.mDiscoveryMessageShown) {
            ...
            GallerySamplingStatHelper.recordCountEvent("quickly_discovery", "quickly_discovery_message_click_status", params);
        }
    }
    ...
    private void recordMessageClickedTime(DiscoveryMessage message) {
        ...
        GallerySamplingStatHelper.recordCountEvent("quickly_discovery", "quickly_discovery_message_click_time", params);
    }
}
