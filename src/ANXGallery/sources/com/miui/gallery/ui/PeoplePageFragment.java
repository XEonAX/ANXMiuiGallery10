...
public class PeoplePageFragment extends BaseFragment {
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.action_ignore_face_album /*2131886813*/:
                    ...
                    break;
                case R.id.action_set_group /*2131886814*/:
            ...
            if (!PeoplePageFragment.this.mInMarkMode) {
                ...
                processTask.setCompleteListener(new OnCompleteListener<Boolean>() {
                    public void onCompleteProcess(Boolean result) {
                        ...
                        GallerySamplingStatHelper.recordCountEvent("people_mark", "mark_relation_in_people_page", params);
                    }
                });
    ...
    private EditableListViewWrapper mPeopleGridViewWrapper;
    ...
    public View onInflateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.mPeopleGridViewWrapper = new EditableListViewWrapper(this.mPeopleGridView);
        ...
        this.mFooterView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                GallerySamplingStatHelper.recordCountEvent("people", "people_list_display_mode", params);
            }
        });
        return view;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_see_ignore_faces /*2131886811*/:
