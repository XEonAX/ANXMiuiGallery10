...
import com.miui.gallery.model.AlbumEntity;
...
public abstract class BaseAlbumPageFragment extends BaseFragment {
    protected AlbumPageRecyclerAdapter mAlbumPageAdapter;
    ...
    protected AlbumEntity mSelectedAlbum;
    ...
    protected void setContextMenuItems(ContextMenu contextMenu, int position) {
        AlbumEntity entity = AlbumEntity.fromCursor(this.mAlbumPageAdapter.getItem(position));
        if (entity == null) {
    ...
    private void statAlbumOperation(AlbumEntity entity, String operation) {
        HashMap<String, String> params = new HashMap();
        params.put(nexExportFormat.TAG_FORMAT_PATH, entity.getLocalPath());
        GallerySamplingStatHelper.recordCountEvent("album", operation, params);
    }
