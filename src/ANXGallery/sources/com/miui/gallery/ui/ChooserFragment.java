...
public class ChooserFragment extends Fragment implements OnPageChangeListener {
    ...
    private static class ResolverAdapter extends PagerAdapter {
        ...
        private View generatorChooserItem(ViewGroup container) {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                if (this.mTheme == 0) {
                    ...
                    textView.setTextAppearance(this.mContext, R.style.f32Gallery.TextAppearance.IconDesc.Light);
                } else {
                    if (this.mIsCrop) {
                    ...
                    textView.setTextAppearance(this.mContext, R.style.f31Gallery.TextAppearance.IconDesc.Dark);
                }
        ...
        public int getItemPosition(Object object) {
            if (((Integer) ((View) object).getTag(R.id.tag_item_position)).intValue() < getCount()) {
                return -3;
            }
            return -2;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            if (tarIntent != null) {
                ...
                this.mPoint = new PagerPoint((LinearLayout) root.findViewById(R.id.pager_point_layout), getResources().getDrawable(theme == 0 ? R.drawable.unselected_point_light : R.drawable.unselected_point_dark), getResources().getDrawable(R.drawable.selected_point));
