            ...
            this.mTaskFuture = ThreadManager.getMiscPool().submit(new Job<Object>() {
                public Object run(JobContext jc) {
                    if (jc == null || !jc.isCancelled()) {
                        ...
                        if (context != null && MiscUtil.isValid(AlbumPageHeaderController.this.mLocationsAlbumCoverServerIds)) {
                        ...
                        if (context != null && MiscUtil.isValid(AlbumPageHeaderController.this.mTagsAlbumCoverServerIds)) {
