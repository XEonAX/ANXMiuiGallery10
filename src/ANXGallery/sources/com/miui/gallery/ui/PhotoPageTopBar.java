...
public class PhotoPageTopBar {
    ...
    private ImageView mRefocusEnterView = ((ImageView) this.mTopLayout.findViewById(R.id.dynamic_refocus_enter));
    ...
    public ImageView getRefocusEnterView() {
        return this.mRefocusEnterView;
    }
