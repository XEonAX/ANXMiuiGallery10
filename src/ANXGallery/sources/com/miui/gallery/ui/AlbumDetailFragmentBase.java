...
public abstract class AlbumDetailFragmentBase extends PhotoListFragmentBase implements OnAppFocusedListener {
    ...
    protected EditableListViewWrapper mAlbumDetailGridViewWrapper;
        ...
        public boolean onActionItemClicked(final ActionMode mode, MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.action_produce /*2131886806*/:
                    ...
                    GallerySamplingStatHelper.recordCountEvent("album_detail", "produce");
                    break;
    ...
    private static class AlbumScanTask implements Job<Void> {
        ...
        public AlbumScanTask(String albumLocalPath) {
            this.mAlbumLocalPath = albumLocalPath;
        }

        public Void run(JobContext jc) {
            Context context = GalleryApp.sGetAndroidContext();
            MediaScannerUtil.scanDirectories(context, Lists.newArrayList(StorageUtils.getAbsolutePath(context, this.mAlbumLocalPath)), 3, false);
            return null;
        }
    }
    ...
    public View onInflateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.mAlbumDetailGridViewWrapper = new EditableListViewWrapper(this.mAlbumDetailGridView);
    ...
    private void scanAlbumFolderIfNeeded() {
        if (!this.mIsOtherShareAlbum && !isVirtualAlbum() && this.mAlbumLocalPath != null) {
            ThreadManager.getMiscPool().submit(new AlbumScanTask(this.mAlbumLocalPath));
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_add_photos /*2131886778*/:
                pickPhotos();
                return true;
            case R.id.menu_share /*2131886785*/:
                showAlbumShareInfo();
                return true;
            default:
    ...
    private void recordCopyMoveAction(boolean deleteOrigin) {
        ...
        GallerySamplingStatHelper.recordCountEvent("organize_photos", "move_or_copy", params);
    }
        ...
        MediaAndAlbumOperations.delete(this.mActivity, "AlbumDetailFragmentBaseDeleteMediaDialogFragment", new OnDeletionCompleteListener() {
            public void onDeleted(int count, long[] deleteIds) {
                if (AlbumDetailFragmentBase.this.mActivity != null) {
                    ...
                    GallerySamplingStatHelper.recordCountEvent("album_detail", "delete_photo", map);
                }
            }
