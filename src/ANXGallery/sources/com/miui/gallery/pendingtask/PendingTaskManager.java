...
public class PendingTaskManager {
    ...
    private static void recordExpireCount() {
        ...
        if (list != null && list.size() > 0) {
            ...
            GallerySamplingStatHelper.recordCountEvent("pending_task", "pending_task_expire_count", params);
    ...
    private static void recordRescheduleCount(int count) {
        ...
        GallerySamplingStatHelper.recordCountEvent("pending_task", "pending_task_reschedule", params);
    }
    ...
    private static void recordFinishDuration(long cost) {
        ...
        int stage = GallerySamplingStatHelper.generatorValueStage(hour, TIME_STAGE);
        HashMap<String, String> params = new HashMap();
        params.put("stage", String.valueOf(stage));
        GallerySamplingStatHelper.recordCountEvent("pending_task", "pending_task_finish_duration", params);
