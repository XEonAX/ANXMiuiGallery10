...
public class RectTimeDrawable extends Drawable {
    ...
    private static String getYearString(long time, Resources resources) {
        return new SimpleDateFormat(resources.getString(R.string.collage_drawable_rect_date_year), BuildUtil.isInternational() ? Locale.getDefault() : Locale.US).format(Long.valueOf(time));
    }

    private static String getDateString(long time, Resources resources) {
        return new SimpleDateFormat(resources.getString(R.string.collage_drawable_rect_date_month_day), BuildUtil.isInternational() ? Locale.getDefault() : Locale.US).format(Long.valueOf(time));
    }
