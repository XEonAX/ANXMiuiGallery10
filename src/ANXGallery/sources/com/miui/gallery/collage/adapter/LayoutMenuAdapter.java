...
public class LayoutMenuAdapter extends Adapter<LayoutHolder> implements Selectable {
    private Context mContext;
    private Delegator mDelegator;
    private List<LayoutModel> mLayoutList;

    public LayoutMenuAdapter(Context context, List<LayoutModel> layoutList, Selector selector) {
