        ...
        protected void bindItem(BaseDataItem item, int position) {
            ...
            if (isValidate(position)) {
                ...
                if (!TextUtils.isEmpty(latitude)) {
                    ...
                    item.setLatitude(LocationUtil.convertRationalLatLonToFloat(latitude, latitudeRef));
                    item.setLongitude(LocationUtil.convertRationalLatLonToFloat(longitude, longitudeRef));
                }
