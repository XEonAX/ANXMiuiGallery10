...
public class LastMonthScenario extends TimeScenario {
    ...
    public List<Long> loadMediaItem() {
        return getImageIdsFromImageFeatures(getCameraMediaIdsByStartEndTimeTags(CardUtil.concat(CardUtil.concat(Constants.TAGS_PARTY, Constants.TAGS_FOODS), CardUtil.concat(Constants.TAGS_ACTIVITY, Constants.TAGS_SPORTS)), getStartTime(), getEndTime()));
    }
