...
public class PastWeekendScenario extends TimeScenario {
    protected static final String SELECTION = (Constants.CAMERA_BASE_SELECTION + " AND " + "mixedDateTime" + " > %s" + " AND " + "mixedDateTime" + " < %s");
    ...
    public String generateTitle(Record record, List<MediaFeatureItem> list) {
        return GalleryApp.sGetAndroidContext().getResources().getString(R.string.card_title_past_week_end);
    }
