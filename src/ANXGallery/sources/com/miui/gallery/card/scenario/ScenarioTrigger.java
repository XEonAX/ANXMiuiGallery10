...
public class ScenarioTrigger {
    private int mFreeScenarioTriggerInterval = 3;
    ...
    public synchronized void trigger() {
        ...
        if (flagDisableMask == 0 && MiscUtil.isValid(this.mFreeScenarios) && !isCardGeneratedRecently(86400000 * ((long) this.mFreeScenarioTriggerInterval))) {
