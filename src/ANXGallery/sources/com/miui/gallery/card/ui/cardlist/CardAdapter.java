    ...
    class CardHolder extends ViewHolder {
        private final AntiDoubleClickListener mAntiDoubleClickListener = new AntiDoubleClickListener() {
            public void onAntiDoubleClick(View v) {
                switch (v.getId()) {
                    case R.id.card_cover /*2131886318*/:
                        CardHolder.this.deliveryAction(CardHolder.this.mCard.getDetailUrl());
                        return;
                    default:
                        return;
                }
        ...
        private void deliveryAction(String url) {
            if (TextUtils.isEmpty(url)) {
                Log.w("CardAdapter", "deliveryAction empty");
                return;
            }
            if (this.mCard != null) {
                ...
                if (selectedMediaSha1s != null && selectedMediaSha1s.size() != 0) {
                    ...
                    extras.putLong("card", this.mCard.getId());
        ...
        private void recordCardClick() {
            ...
            GallerySamplingStatHelper.recordCountEvent("assistant", "assistant_card_click", params);
        }
    }
