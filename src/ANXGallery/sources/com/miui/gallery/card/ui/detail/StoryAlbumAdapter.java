...
import com.miui.gallery.adapter.BaseGalleryRecyclerAdapter;
...
public class StoryAlbumAdapter extends BaseGalleryRecyclerAdapter<BaseViewHolder> {
    ...
    public void onBindViewHolder(BaseViewHolder viewHolder, int position) {
        ...
        recyclerViewItem.bindImage(position, getClearThumbFilePath(position), getDownloadUri(position), DownloadType.THUMBNAIL, this.mDisplayImageOptions);
    ...
    public Uri getDownloadUri(int position) {
        return BaseGalleryRecyclerAdapter.getDownloadUri(moveCursorToPosition(position), 16, 0);
    }
    ...
    public String getLocalPath(int position) {
        return BaseGalleryRecyclerAdapter.getMicroPath(moveCursorToPosition(position), 1, 15);
    }
