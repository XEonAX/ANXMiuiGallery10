...
public class GalleryJobService extends JobService {
    ...
    private class JobTask extends Task {
        ...
        public Object doLoad() throws Exception {
            ...
            GallerySamplingStatHelper.recordCountEvent("JobServiceStarted", jobClass.getName(), GallerySamplingStatHelper.generatorCommonParams());
        ...
        public void onResult(TaskManager tm, Object result) {
            ...
            if (result == null || !(result instanceof Boolean) || ((Boolean) result).booleanValue()) {
                ...
                GallerySamplingStatHelper.recordCountEvent("JobServiceDone", this.mJob != null ? this.mJob.getClass().getName() : "jobId: " + this.mJobParams.getJobId(), params);
                return;
            }
            String name;
            ...
            GallerySamplingStatHelper.recordErrorEvent(str, name, params);
            if (needsReschedule) {
                GallerySamplingStatHelper.recordErrorEvent("JobServiceRescheduled", this.mJob.getClass().getName(), params);
            }
        }
    }
    ...
    public static void scheduleJob(Context context, AbstractJob job) {
        ...
        if (info == null) {
            ...
            GallerySamplingStatHelper.recordCountEvent("JobServiceScheduled", job.getClass().getName(), GallerySamplingStatHelper.generatorCommonParams());
        }
    }
