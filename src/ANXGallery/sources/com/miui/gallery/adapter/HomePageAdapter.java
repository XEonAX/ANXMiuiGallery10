...
public class HomePageAdapter extends PreloadMediaAdapter implements CheckableAdapter, StickyGridHeadersBaseAdapter {
    ...
    public HomePageAdapter(Context context) {
        this(context, SyncStateShowScene.SCENE_IN_CHECK_MODE);
    }

    public HomePageAdapter(Context context, SyncStateShowScene type) {
        super(context, type);
    }
    ...
    public View getHeaderView(int position, View convertView, ViewGroup parent) {
        ...
        ((HomePageGridHeaderItem) convertView).bindData(((Cursor) getItem(((Integer) this.mGroupStartPos.get(position)).intValue())).getLong(15), (String) this.mGroupStartLocations.get(position));
        return convertView;
    }
