...
public abstract class PreloadMediaAdapter extends BaseMediaSyncStateAdapter {
    ...
    public PreloadMediaAdapter(Context context, SyncStateShowScene scene) {
        super(context, scene);
    }

    public PreloadMediaAdapter(Context context, SyncStateShowScene scene, int syncStateDisplayOptions) {
    ...
    private void loadImage(int position) {
        ...
        ImageLoader.getInstance().displayImage(imageUri, aware, getDisplayImageOptions(position));
    ...
    public final OnScrollListener generatePreloadListener(OnScrollListener scrollListener) {
        if (this.mPreloadListener == null) {
            this.mPreloadListener = new PreloadOnScrollListener(scrollListener);
        }
