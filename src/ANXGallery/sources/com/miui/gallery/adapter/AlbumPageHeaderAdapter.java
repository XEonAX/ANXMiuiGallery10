...
public class AlbumPageHeaderAdapter extends BaseAdapter {
    ...
    private static abstract class BaseViewHolder {
        ...
        protected void bindDefaultCover(int defaultCoverRes) {
            ...
            ImageLoader.getInstance().displayImage(Scheme.DRAWABLE.wrap(String.valueOf(defaultCoverRes)), this.mDefaultAlbumCover, sDefaultCoverDisplayImageOptions, ThumbConfig.get().sAlbumHeaderThumbTargetSize, null);
        }
