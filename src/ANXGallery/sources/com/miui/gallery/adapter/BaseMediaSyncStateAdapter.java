...
public abstract class BaseMediaSyncStateAdapter extends BaseMediaAdapter {
    ...
    protected SyncStateShowScene mShowScene;
    ...
    public enum SyncStateShowScene {
        SCENE_NONE,
        SCENE_IN_CHECK_MODE,
        SCENE_ALWAYS
    }
    ...
    public BaseMediaSyncStateAdapter(Context context) {
        this(context, SyncStateShowScene.SCENE_NONE);
    }

    public BaseMediaSyncStateAdapter(Context context, SyncStateShowScene scene) {
        this(context, scene, 7);
    }

    public BaseMediaSyncStateAdapter(Context context, SyncStateShowScene scene, int syncStateDisplayOptions) {
        super(context);
