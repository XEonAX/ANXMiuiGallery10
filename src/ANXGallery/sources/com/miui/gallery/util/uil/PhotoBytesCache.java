...
public class PhotoBytesCache {
    ...
    private void recordInitError(Exception e, File cacheDir) {
        ...
        GallerySamplingStatHelper.recordErrorEvent("pager_decode_bitmap", "pager_photo_cache_init_error", params);
    }
        ...
        synchronized (this.mLock) {
            if (this.mBlobCache != null) {
                try {
                    ...
                    this.mBlobCache.insert(MiscUtil.crc64Long(imageUri.getBytes()), data);
                } catch (Throwable e) {
                    Log.e("PhotoBytesCache", e);
                    z = false;
                }
        ...
        synchronized (this.mLock) {
            try {
                if (this.mBlobCache != null) {
                    ...
                    data = this.mBlobCache.lookup(MiscUtil.crc64Long(imageUri.getBytes()));
