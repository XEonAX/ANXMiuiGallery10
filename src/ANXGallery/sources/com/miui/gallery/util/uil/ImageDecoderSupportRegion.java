    ...
    public Bitmap decode(ImageDecodingInfo decodingInfo) throws IOException {
        ...
        try {
            ...
            if (decodingInfo.isRegionDecodeFace()) {
                decodedBitmap = DecodeRegionImageUtils.decodeFaceRegion(decodingInfo.getRegionDecodeRect(), imageStream, 2.0f, decodingInfo.getTargetSize().getWidth(), imageInfo.exif.exifOrientation);
            } else {
