...
public class MicroThumbCache {
    ...
    private C0009SoftReferencePool<Bitmap> mBitmapPool;
    private BlobCache mBlobCache;
    private Object mBlobLock = new Object();
    private final File mCacheDir;
    private final int mCacheMaxSize;
    private C0009SoftReferencePool<LookupRequest> mLookupRequestPool;
    ...
    private synchronized void ensureInitialized() throws IOException {
        if (this.mBlobCache == null) {
            ...
            try {
                ...
                this.mLookupRequestPool = C0010Pools.createSoftReferencePool(new C0000Manager<LookupRequest>() {
                    public LookupRequest createInstance() {
                        return new LookupRequest();
                    }
                }, 32);
                this.mBitmapPool = C0010Pools.createSoftReferencePool(new C0000Manager<Bitmap>() {
    ...
    public boolean save(String imageUri, Bitmap bitmap) throws IOException {
        ...
        if (buffer != null) {
            synchronized (this.mBlobLock) {
                ...
                this.mBlobCache.insert(MiscUtil.crc64Long(imageUri.getBytes()), buffer.array());
            }
        }
        return true;
    }
    ...
    public Bitmap getCenterCropBitmap(String memoryKey, Bitmap reusedBitmap) {
        ...
        try {
            ...
            lookRequest.key = MiscUtil.crc64Long(memoryKey.getBytes());
