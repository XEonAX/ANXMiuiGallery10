...
public class LoadMonitor {
    ...
    private static class Recorder {
        ...
        private final int mAssertLine = (this.mBadLine * 10);
        ...
        public Recorder(int type, boolean initialSyncValue, int frequency, int goodLine, int badLine) {
            ...
            this.mGoodLine = goodLine * 1000000;
            this.mBadLine = badLine * 1000000;
        }
    ...
    static {
        RECORDERS[0] = new Recorder(0, false, 10, 1, 3);
        RECORDERS[1] = new Recorder(1, false, 1, 8, 16);
    }
