...
public class FileUtils extends miui.os.FileUtils {
    ...
    public static boolean createFolder(File destFolderFile, boolean hideFolder) {
        ...
        if (destFolderFile.exists()) {
            if (hideFolder) {
                try {
                    if (DocumentProviderUtils.needUseDocumentProvider(destFolderFile.getAbsolutePath())) {
                        DocumentFile destFolderDocumentFile = DocumentProviderUtils.getDocumentFile(GalleryApp.sGetAndroidContext(), destFolderFile);
    ...
    private static boolean mkdirsCustomize(File file, int mode, int uid, int gid) {
        ...
        if (file.mkdir()) {
            ...
            DocumentFile documentFile = DocumentProviderUtils.getDocumentFileDirectory(GalleryApp.sGetAndroidContext(), file);
    ...
    public static boolean copyFile(File srcFile, File destFile) {
        if (DocumentProviderUtils.needUseDocumentProvider(destFile.getAbsolutePath())) {
    ...
    public static boolean copyFileByDocumentProvider(InputStream inputStream, File destFile) {
        try {
            if (destFile.exists()) {
            ...
            return ((Boolean) DocumentProviderUtils.safeWriteFile(inputStream, destFile, new WriteHandler<Boolean>() {
                public Boolean handle(InputStream inputStream, FileOutputStream out) {
                    try {
    ...
    public static boolean renameFile(File srcFile, File desFile) {
        ...
        if (!DocumentProviderUtils.needUseDocumentProvider(desFile.getAbsolutePath())) {
