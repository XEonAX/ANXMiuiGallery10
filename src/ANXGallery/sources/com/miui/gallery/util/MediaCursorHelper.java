...
public class MediaCursorHelper {
    ...
    public static float getLatitude(Cursor cursor) {
        ...
        return LocationUtil.convertRationalLatLonToFloat(latitude, cursor.getString(12));
    }
    ...
    public static float getLongitude(Cursor cursor) {
        ...
        return LocationUtil.convertRationalLatLonToFloat(longitude, cursor.getString(14));
    }
