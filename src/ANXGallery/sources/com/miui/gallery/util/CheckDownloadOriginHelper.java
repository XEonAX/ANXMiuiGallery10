...
public class CheckDownloadOriginHelper {
    ...
    class CheckOriginTask extends AsyncTask<Void, Void, List<MediaItem>> {
        ...
        protected List<MediaItem> doInBackground(Void... params) {
            ...
            if (isLocalAlbum()) {
                ...
                if (MiscUtil.isValid(mediaItems)) {
                    downloadItems = null;
    ...
    private void doDownloadOrigin(final List<MediaItem> list, boolean ignoreNetwork) {
        ...
        DialogUtil.showInfoDialog(this.mContext, false, this.mContext.getString(R.string.download_without_wifi_msg), this.mContext.getString(R.string.download_without_wifi_title), 17039370, 17039360, new OnClickListener() {
