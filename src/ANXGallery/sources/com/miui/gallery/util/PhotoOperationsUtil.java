...
public class PhotoOperationsUtil {
    ...
    public static int getImageSupportedOperations(String filePath, String mimeType, float latitude, float longitude) {
        ...
        if (LocationUtil.isValidateCoordidate(latitude, longitude)) {
            operation |= 16;
        }
