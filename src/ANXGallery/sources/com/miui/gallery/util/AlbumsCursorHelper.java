...
public class AlbumsCursorHelper {
    public static final String[] ALL_ALBUMS_PROJECTION = new String[]{"_id", "name", "cover_id", "cover_path", "cover_sha1", "cover_sync_state", "media_count", "face_people_id", "baby_info", "thumbnail_info", "serverId", "attributes", "album_unwriteable", "top_time", "sortBy", "baby_sharer_info", "local_path"};
    private HashMap<Long, Integer> mAlbumId2CursorPosMapping;
    ...
    public boolean isAlbumDataValid(long albumId) {
        return (this.mAlbumId2CursorPosMapping == null || this.mAlbumId2CursorPosMapping.get(Long.valueOf(albumId)) == null) ? false : true;
    }
    ...
    public synchronized void setAlbumsData(Cursor cursor) {
        ...
        if (cursor == null || cursor.isClosed()) {
            ...
            this.mCursor = cursor;
            if (this.mAlbumId2CursorPosMapping == null) {
                this.mAlbumId2CursorPosMapping = new HashMap();
            }
            cursor.moveToFirst();
            while (!cursor.isAfterLast()) {
                this.mAlbumId2CursorPosMapping.put(Long.valueOf(getAlbumId(cursor)), Integer.valueOf(cursor.getPosition()));
                cursor.moveToNext();
            }
        }
    }
    ...
    public String getAlbumLocalPath(Long albumId) {
        return getAlbumLocalPath(((Integer) this.mAlbumId2CursorPosMapping.get(albumId)).intValue());
    }
    ...
    public String getAlbumName(long albumId) {
        return getAlbumName(((Integer) this.mAlbumId2CursorPosMapping.get(Long.valueOf(albumId))).intValue());
    }
    ...
    public long getAttributes(long albumId) {
        return getAttributes(((Integer) this.mAlbumId2CursorPosMapping.get(Long.valueOf(albumId))).intValue());
    }
    ...
    public String getServerId(long albumId) {
        return getServerId(((Integer) this.mAlbumId2CursorPosMapping.get(Long.valueOf(albumId))).intValue());
    }
    ...
    public boolean isOtherShareAlbum(long albumId) {
        return isOtherShareAlbum(((Integer) this.mAlbumId2CursorPosMapping.get(Long.valueOf(albumId))).intValue());
    }
    ...
    public boolean isLocalAlbum(long albumId) {
        return isLocalAlbum(((Integer) this.mAlbumId2CursorPosMapping.get(Long.valueOf(albumId))).intValue());
    }
    ...
    public boolean isBabyAlbum(long albumId) {
        return isBabyAlbum(((Integer) this.mAlbumId2CursorPosMapping.get(Long.valueOf(albumId))).intValue());
    }
    ...
    public String getBabyAlbumPeopleId(long albumId) {
        return getBabyAlbumPeopleId(((Integer) this.mAlbumId2CursorPosMapping.get(Long.valueOf(albumId))).intValue());
    }
    ...
    public String getThumbnailInfoOfBaby(long albumId) {
        return getThumbnailInfoOfBaby(((Integer) this.mAlbumId2CursorPosMapping.get(Long.valueOf(albumId))).intValue());
    }
    ...
    public String getBabyInfo(long albumId) {
        return getBabyInfo(((Integer) this.mAlbumId2CursorPosMapping.get(Long.valueOf(albumId))).intValue());
    }
    ...
    public String getBabySharerInfo(long albumId) {
        return getBabySharerInfo(((Integer) this.mAlbumId2CursorPosMapping.get(Long.valueOf(albumId))).intValue());
    }
    ...
    public boolean albumUnwriteable(long albumId) {
        return albumUnwriteable(((Integer) this.mAlbumId2CursorPosMapping.get(Long.valueOf(albumId))).intValue());
    }
