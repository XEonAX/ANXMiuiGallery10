...
public class Storage {
    ...
    public static String getExternalSDCardRoot() {
        if (BuildUtil.isUUIDSDCard()) {
            for (StorageInfo info : StorageManager.getInstance().getStorageInfos(GalleryApp.sGetAndroidContext())) {
    ...
    public static String[] getAllSdCardAvatarFilePath() {
        return StorageUtils.getPathsInExternalStorage(GalleryApp.sGetAndroidContext(), "/MIUI/Gallery/cloud/.avatar");
    }

    @Deprecated
    public static String[] getCloudThumbnailFilePath() {
        return StorageUtils.getPathsInExternalStorage(GalleryApp.sGetAndroidContext(), "/MIUI/Gallery/cloud/.thumbnailFile");
    }

    @Deprecated
    public static String[] getCloudThumbnailModifiedTimeMapFilePath() {
        return StorageUtils.getPathsInExternalStorage(GalleryApp.sGetAndroidContext(), "/MIUI/Gallery/cloud/.thumbnaillastmodifiedtime");
    }

    public static String[] getCloudWaitUploadFilePath() {
        return StorageUtils.getPathsInExternalStorage(GalleryApp.sGetAndroidContext(), "/MIUI/Gallery/cloud/.waitUpload");
    }
