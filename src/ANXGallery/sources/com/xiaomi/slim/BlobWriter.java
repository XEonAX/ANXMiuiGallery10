...
public class BlobWriter {
    ...
    public void openStream() throws IOException {
        ...
        write(blob);
        MyLog.w("[slim] open conn: andver=" + VERSION.SDK_INT + " sdk=" + 37 + " hash=" + ServiceConfig.getDeviceUUID() + " tz=" + this.mTimeZone + ":" + this.mDSTSavings + " Model=" + Build.MODEL + " os=" + VERSION.INCREMENTAL);
    }
