...
public class MessageView extends LinearLayout {
    ...
    private void b(Context context, AttributeSet attributeSet, int i) {
        ...
        this.vp.setId(16908308);
        this.vp.setText(string);
        this.vp.setTextColor(colorStateList);
        this.vp.setTextSize(0, (float) getResources().getDimensionPixelSize(R.dimen.message_view_text_size));
