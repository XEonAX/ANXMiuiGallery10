...
public class GuidePopupWindow extends ArrowPopupWindow {
    ...
    private static final int Tl = 5000;
    private int Rg;
    private LinearLayout Tk;
    private Runnable Tm = new Runnable() {
        public void run() {
    ...
    protected void onPrepareWindow() {
        ...
        this.Rg = Tl;
        setFocusable(true);
        this.Tk = (LinearLayout) getLayoutInflater().inflate(R.layout.guide_popup_content_view, null, false);
    ...
    public void show(View view, int i, int i2, boolean z) {
        show(view, i, i2);
        if (z) {
            this.mArrowPopupView.postDelayed(this.Tm, (long) this.Rg);
        }
    }
