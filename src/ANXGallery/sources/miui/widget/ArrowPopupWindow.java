...
public class ArrowPopupWindow extends PopupWindow {
    ...
    private void ef() {
        int i;
        this.OJ = this.mContext.getResources().getDimensionPixelOffset(R.dimen.arrow_popup_window_list_max_height);
    ...
    public void show(View view, int i, int i2) {
        ...
        Factory.getInstance().get().setLayoutInScreenEnabled(this, eg());
    ...
    public void setContentHeight(int i) {
        View contentView = getContentView();
        if ((contentView instanceof ListView) && i > this.OJ) {
            i = this.OJ;
        }
        if (contentView != null) {
            LayoutParams layoutParams = contentView.getLayoutParams();
