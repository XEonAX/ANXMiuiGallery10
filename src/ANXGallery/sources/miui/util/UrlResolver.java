    ...
    private static ResolveInfo a(Context context, boolean z, PackageManager packageManager, Object obj, Intent intent, String str, int i, List<ResolveInfo> list, int i2) {
        ...
        if (!z) {
            if (VERSION.SDK_INT > 20) {
                try {
                    if (JN == null) {
                        JN = context2.getClassLoader().loadClass("com.android.server.pm.PackageManagerService").getDeclaredMethod("resolveIntent", new Class[]{Intent.class, String.class, Integer.TYPE, Integer.TYPE});
                    }
                    resolveInfo = (ResolveInfo) JN.invoke(obj2, new Object[]{intent2, str2, Integer.valueOf(i), Integer.valueOf(i2)});
                } catch (Exception e2) {
                    e2.printStackTrace();
                    return null;
                }
