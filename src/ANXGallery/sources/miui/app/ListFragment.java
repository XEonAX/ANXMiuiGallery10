...
public class ListFragment extends android.app.ListFragment implements IFragment {
    ...
    public void invalidateOptionsMenu() {
        if (this.wU != null) {
            ...
            if (!isHidden() && this.wV && this.wW && isAdded()) {
                this.wU.invalidateOptionsMenu();
            }
        }
    }
    ...
    public void updateOptionsMenuContent() {
        if (this.wU != null && !isHidden() && this.wV && this.wW && isAdded()) {
            this.wU.invalidateOptionsMenu();
        }
    }
    ...
    public boolean onCreatePanelMenu(int i, Menu menu) {
        ...
        if (this.wV && this.wW && !isHidden() && isAdded()) {
    ...
    public void onPreparePanel(int i, View view, Menu menu) {
        if (i == 0 && this.wV && this.wW && !isHidden() && isAdded()) {
