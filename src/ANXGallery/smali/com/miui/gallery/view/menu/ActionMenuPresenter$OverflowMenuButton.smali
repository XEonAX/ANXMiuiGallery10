...
.method public constructor <init>(Lcom/miui/gallery/view/menu/ActionMenuPresenter;Landroid/content/Context;)V
    ...
    invoke-direct {p0, p2, v2, v0}, Landroid/widget/Button;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 477
    invoke-virtual {p0, v1}, Lcom/miui/gallery/view/menu/ActionMenuPresenter$OverflowMenuButton;->setClickable(Z)V

    .line 478
    invoke-virtual {p0, v1}, Lcom/miui/gallery/view/menu/ActionMenuPresenter$OverflowMenuButton;->setFocusable(Z)V
    ...
    .line 480
    invoke-virtual {p0, v1}, Lcom/miui/gallery/view/menu/ActionMenuPresenter$OverflowMenuButton;->setEnabled(Z)V

    .line 482
    invoke-virtual {p0, v2}, Lcom/miui/gallery/view/menu/ActionMenuPresenter$OverflowMenuButton;->setText(Ljava/lang/CharSequence;)V
