...
.method private querySyncInfo(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    .prologue
    .line 773
    sget-object v8, Lcom/miui/gallery/provider/deprecated/GalleryCloudProvider;->sUriMatcher:Landroid/content/UriMatcher;
    ...
    const-string v9, "(%s) AND (%s = %s OR %s = %s) AND (%s = %s OR %s = %s)"
    ...
    sget-object v12, Lcom/miui/gallery/cloud/CloudUtils;->SELECTION_OWNER_NEED_SYNC:Ljava/lang/String;
    ...
    const-string v9, "(%s = %d OR %s = %d) AND (%s = %s OR %s = %s)"
    ...
    const-string v9, "%s = \'%s\' AND %s = %d AND (%s = %s OR %s = %s) "
    ...
    .line 792
    .local v2, "SYNCED_SELECTION":Ljava/lang/String;
    const/4 v6, -0x1

    .line 793
    .local v6, "syncableCount":I
    const/4 v7, -0x1

    .line 796
    .local v7, "syncedCount":I
    if-nez p2, :cond_0
    ...
    const-string/jumbo v9, "syncableCount"
    ...
    .line 801
    .local v4, "columnValues":[Ljava/lang/Integer;
    const/4 v5, 0x0
    ...
    invoke-direct {p0, v8, v0}, Lcom/miui/gallery/provider/deprecated/GalleryCloudProvider;->getMediaCount(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 805
    invoke-direct {p0, v9, v1}, Lcom/miui/gallery/provider/deprecated/GalleryCloudProvider;->getMediaCount(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string/jumbo v9, "syncedCount"
    ...
    invoke-direct {p0, v8, v2}, Lcom/miui/gallery/provider/deprecated/GalleryCloudProvider;->getMediaCount(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 811
    invoke-direct {p0, v9, v2}, Lcom/miui/gallery/provider/deprecated/GalleryCloudProvider;->getMediaCount(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string/jumbo v10, "unsupported argument: "
    ...
    .line 818
    :cond_5
    const-string v8, "GalleryCloudProvider"

    const-string v9, "query syncInfo syncableCount[%d], syncedCount[%d]"
    ...
    invoke-static {v8, v9, v10, v11}, Lcom/miui/gallery/util/SyncLog;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 823
    .end local v0    # "OWNER_DIRTY_SELECTION":Ljava/lang/String;
    .end local v1    # "SHARER_DIRTY_SELECTION":Ljava/lang/String;
    .end local v2    # "SYNCED_SELECTION":Ljava/lang/String;
    .end local v3    # "c":Landroid/database/MatrixCursor;
    .end local v4    # "columnValues":[Ljava/lang/Integer;
    .end local v5    # "i":I
    .end local v6    # "syncableCount":I
    .end local v7    # "syncedCount":I
    :goto_2
    return-object v3
...
.method protected onPreInsert(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Landroid/content/ContentValues;)J
    ...
    const-string v5, "sha1=? AND localGroupId=? AND (localFlag NOT IN (11, 0, -1, 2) OR (localFlag=0 AND serverStatus=\'custom\'))"
    ...
    const-string v5, "sha1=? AND localGroupId=? AND (localFlag NOT IN (11, 0, -1, 2) OR (localFlag=0 AND serverStatus=\'custom\')) AND fileName=?"
