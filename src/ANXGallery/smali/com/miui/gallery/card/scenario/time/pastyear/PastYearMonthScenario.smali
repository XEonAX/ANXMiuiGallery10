...
.method public onPrepare(Ljava/util/List;Ljava/util/List;)Z
    ...
    invoke-virtual/range {p0 .. p2}, Lcom/miui/gallery/card/scenario/time/pastyear/PastYearMonthScenario;->getRecordStartTimesFromRecordAndCards(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v9, v0, v1, v10}, Lcom/miui/gallery/card/scenario/DateUtils;->getLastNYearMonthTime(IJZ)J

    move-result-wide v6

    .line 33
    .local v6, "pastYearMonthStart":J
    const/4 v9, 0x1
    ...
    .line 41
    .end local v4    # "pastYearMonthEnd":J
    .end local v6    # "pastYearMonthStart":J
    :goto_0
    return v9

    .line 37
    .restart local v4    # "pastYearMonthEnd":J
    .restart local v6    # "pastYearMonthStart":J
    :cond_1
    invoke-virtual {p0, v6, v7}, Lcom/miui/gallery/card/scenario/time/pastyear/PastYearMonthScenario;->setStartTime(J)V

    .line 38
    invoke-virtual {p0, v4, v5}, Lcom/miui/gallery/card/scenario/time/pastyear/PastYearMonthScenario;->setEndTime(J)V
