...
.method public initSupportOperations()I
    ...
    .line 227
    :cond_2
    iget-object v2, p0, Lcom/miui/gallery/model/CloudItem;->mMimeType:Ljava/lang/String;

    iget v3, p0, Lcom/miui/gallery/model/CloudItem;->mLatitude:F

    iget v4, p0, Lcom/miui/gallery/model/CloudItem;->mLongitude:F

    invoke-static {v0, v2, v3, v4}, Lcom/miui/gallery/util/PhotoOperationsUtil;->getImageSupportedOperations(Ljava/lang/String;Ljava/lang/String;FF)I
    ...
    invoke-static {v2, v0}, Lcom/miui/gallery/util/StorageUtils;->isInExternalStorage(Landroid/content/Context;Ljava/lang/String;)Z
