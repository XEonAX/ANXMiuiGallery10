...
.method protected bindItem(Lcom/miui/gallery/model/BaseDataItem;I)V
    ...
    invoke-static {v1, v2}, Lcom/miui/gallery/data/LocationUtil;->convertRationalLatLonToFloat(Ljava/lang/String;Ljava/lang/String;)F

    move-result v8

    invoke-virtual {p1, v8}, Lcom/miui/gallery/model/BaseDataItem;->setLatitude(F)Lcom/miui/gallery/model/BaseDataItem;

    .line 108
    invoke-static {v3, v4}, Lcom/miui/gallery/data/LocationUtil;->convertRationalLatLonToFloat(Ljava/lang/String;Ljava/lang/String;)F

    move-result v8

    invoke-virtual {p1, v8}, Lcom/miui/gallery/model/BaseDataItem;->setLongitude(F)Lcom/miui/gallery/model/BaseDataItem;
