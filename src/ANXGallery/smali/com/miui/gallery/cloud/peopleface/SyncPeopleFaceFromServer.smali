...
.method private handleFaceInfosDataJson(Lorg/json/JSONObject;)V
    ...
    .line 364
    :cond_1
    const-string v6, "faceInfoRecords"
    ...
    .line 366
    .local v2, "faceInfoRecords":Lorg/json/JSONArray;
    if-eqz v2, :cond_2
    ...
    .line 367
    :cond_2
    const-string/jumbo v6, "syncface"

    const-string v7, "response face info is empty"
    ...
    const-string v7, "handleFaceInfosDataJson one batch:"
    ...
    .line 373
    .local v5, "oneFace":Lorg/json/JSONObject;
    ...
    .line 377
    .local v1, "faceInfo":Lorg/json/JSONObject;
    const-string v6, "imageIds"
    ...
    .line 379
    .local v4, "imageIds":Lorg/json/JSONArray;
    invoke-direct {p0, v1, v0}, Lcom/miui/gallery/cloud/peopleface/SyncPeopleFaceFromServer;->putFacePositionInfo2Db(Lorg/json/JSONObject;Ljava/lang/String;)V

    .line 380
    invoke-direct {p0, v4, v0}, Lcom/miui/gallery/cloud/peopleface/SyncPeopleFaceFromServer;->putFaceImageIdsInfo2Db(Lorg/json/JSONArray;Ljava/lang/String;)V
...
.method private putFacePositionInfo2Db(Lorg/json/JSONObject;Ljava/lang/String;)V
    .locals 27
