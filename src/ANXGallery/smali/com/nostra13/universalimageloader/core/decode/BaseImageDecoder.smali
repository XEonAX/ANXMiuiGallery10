...
.method private defineExifOrientation(Ljava/io/InputStream;)Lcom/nostra13/universalimageloader/core/decode/BaseImageDecoder$ExifInfo;
    ...
    invoke-virtual {v1, v4}, Lcom/miui/gallery3d/exif/ExifInterface;->getTagIntValue(I)Ljava/lang/Integer;

    move-result-object v2

    .line 265
    .local v2, "exifOrientation":Ljava/lang/Integer;
    if-nez v2, :cond_0
    ...
    :goto_0
    invoke-direct {p0, v3}, Lcom/nostra13/universalimageloader/core/decode/BaseImageDecoder;->packageExifInfo(I)Lcom/nostra13/universalimageloader/core/decode/BaseImageDecoder$ExifInfo;

    move-result-object v4

    .line 270
    .end local v1    # "exif":Lcom/miui/gallery3d/exif/ExifInterface;
    .end local v2    # "exifOrientation":Ljava/lang/Integer;
    ...
    .restart local v2    # "exifOrientation":Ljava/lang/Integer;
    :cond_0
    ...
    const-string v4, "Can\'t read EXIF tags from stream"
    ...
    .line 270
    new-instance v4, Lcom/nostra13/universalimageloader/core/decode/BaseImageDecoder$ExifInfo;

    invoke-direct {v4}, Lcom/nostra13/universalimageloader/core/decode/BaseImageDecoder$ExifInfo;-><init>()V
