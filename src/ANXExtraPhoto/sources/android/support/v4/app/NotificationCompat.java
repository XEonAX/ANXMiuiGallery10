...
public class NotificationCompat {
    ...
    static class NotificationCompatImplJellybean extends NotificationCompatImplBase {
        ...
        public Notification build(Builder b, BuilderExtender extender) {
            ...
            boolean z3 = z2;
            z2 = z3;
            android.support.v4.app.NotificationCompatJellybean.Builder builder2 = new android.support.v4.app.NotificationCompatJellybean.Builder(context, notification, charSequence, charSequence2, charSequence3, remoteViews, i, pendingIntent, pendingIntent2, bitmap, i2, i3, z, z2, builder.mPriority, builder.mSubText, builder.mLocalOnly, builder.mExtras, builder.mGroupKey, builder.mGroupSummary, builder.mSortKey);
    ...
    static class NotificationCompatImplKitKat extends NotificationCompatImplJellybean {
        ...
        public Notification build(Builder b, BuilderExtender extender) {
            ...
            boolean z3 = z2;
            z2 = z3;
            android.support.v4.app.NotificationCompatKitKat.Builder builder2 = new android.support.v4.app.NotificationCompatKitKat.Builder(context, notification, charSequence, charSequence2, charSequence3, remoteViews, i, pendingIntent, pendingIntent2, bitmap, i2, i3, z, z2, builder.mUseChronometer, builder.mPriority, builder.mSubText, builder.mLocalOnly, builder.mPeople, builder.mExtras, builder.mGroupKey, builder.mGroupSummary, builder.mSortKey);
            NotificationCompat.addActionsToBuilder(builder2, builder.mActions);
            NotificationCompat.addStyleToBuilderJellybean(builder2, builder.mStyle);
            return extender.build(builder, builder2);
        }
    ...
    static class NotificationCompatImplApi20 extends NotificationCompatImplKitKat {
        ...
        public Notification build(Builder b, BuilderExtender extender) {
            ...
            boolean z3 = z2;
            z2 = z3;
            android.support.v4.app.NotificationCompatApi20.Builder builder2 = new android.support.v4.app.NotificationCompatApi20.Builder(context, notification, charSequence, charSequence2, charSequence3, remoteViews, i, pendingIntent, pendingIntent2, bitmap, i2, i3, z, z2, builder.mUseChronometer, builder.mPriority, builder.mSubText, builder.mLocalOnly, builder.mPeople, builder.mExtras, builder.mGroupKey, builder.mGroupSummary, builder.mSortKey);
            NotificationCompat.addActionsToBuilder(builder2, builder.mActions);
            NotificationCompat.addStyleToBuilderJellybean(builder2, builder.mStyle);
            return extender.build(builder, builder2);
        }
    ...
    static class NotificationCompatImplApi21 extends NotificationCompatImplApi20 {
        ...
        public Notification build(Builder b, BuilderExtender extender) {
            ...
            boolean z3 = z2;
            z2 = z3;
            android.support.v4.app.NotificationCompatApi21.Builder builder2 = new android.support.v4.app.NotificationCompatApi21.Builder(context, notification, charSequence, charSequence2, charSequence3, remoteViews, i, pendingIntent, pendingIntent2, bitmap, i2, i3, z, z2, builder.mUseChronometer, builder.mPriority, builder.mSubText, builder.mLocalOnly, builder.mCategory, builder.mPeople, builder.mExtras, builder.mColor, builder.mVisibility, builder.mPublicVersion, builder.mGroupKey, builder.mGroupSummary, builder.mSortKey);
            NotificationCompat.addActionsToBuilder(builder2, builder.mActions);
            NotificationCompat.addStyleToBuilderJellybean(builder2, builder.mStyle);
            return extender.build(builder, builder2);
        }
