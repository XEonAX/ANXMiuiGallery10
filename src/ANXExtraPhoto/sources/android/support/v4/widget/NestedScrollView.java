...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent, NestedScrollingChild {
                ...
                if (keyCode != 62) {
                    switch (keyCode) {
                        ...
                        case MotionEventCompat.AXIS_RUDDER /*20*/:
                            if (!event.isAltPressed()) {
                                canScroll = arrowScroll(TransportMediator.KEYCODE_MEDIA_RECORD);
                                break;
                            }
                            canScroll = fullScroll(TransportMediator.KEYCODE_MEDIA_RECORD);
                            break;
                    }
                }
    ...
    public boolean arrowScroll(int direction) {
        ...
        if (nextFocused == null || !isWithinDeltaOfScreen(nextFocused, maxJump, getHeight())) {
            ...
            doScrollY(direction == TransportMediator.KEYCODE_MEDIA_RECORD ? scrollDelta : -scrollDelta);
        } else {
