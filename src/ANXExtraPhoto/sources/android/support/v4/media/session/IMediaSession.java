...
public interface IMediaSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMediaSession {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code != 1598968902) {
                ResultReceiverWrapper _arg0 = null;
                String _arg02;
                Bundle _arg1;
                switch (code) {
                    case 1:
                        ...
                        if (data.readInt() != 0) {
                            _arg0 = (ResultReceiverWrapper) ResultReceiverWrapper.CREATOR.createFromParcel(data);
                        }
                        sendCommand(_arg02, _arg12, _arg0);
                    ...
                    case 6:
                        data.enforceInterface(DESCRIPTOR);
                        _arg02 = getPackageName();
                        reply.writeNoException();
                        reply.writeString(_arg02);
                        return true;
                    case 7:
                        data.enforceInterface(DESCRIPTOR);
                        _arg02 = getTag();
