...
import com.miui.extraphoto.refocus.widget.recyclerview.overscroll.IOverScrollInterface.IOverScrollDecoratorAdapter;
...
public class RecyclerViewOverScrollDecorAdapter implements IOverScrollDecoratorAdapter {
    ...
    protected class ImplHorizLayout implements Impl {
        ...
        public boolean isInAbsoluteStart() {
            return RecyclerViewOverScrollDecorAdapter.this.mRecyclerView.canScrollHorizontally(-1) ^ 1;
        }

        public boolean isInAbsoluteEnd() {
            return RecyclerViewOverScrollDecorAdapter.this.mRecyclerView.canScrollHorizontally(1) ^ true;
        }
    }
    ...
    protected class ImplVerticalLayout implements Impl {
        ...
        public boolean isInAbsoluteStart() {
            return RecyclerViewOverScrollDecorAdapter.this.mRecyclerView.canScrollVertically(-1) ^ 1;
        }

        public boolean isInAbsoluteEnd() {
            return RecyclerViewOverScrollDecorAdapter.this.mRecyclerView.canScrollVertically(1) ^ true;
        }
    }
    ...
    public RecyclerViewOverScrollDecorAdapter(RecyclerView recyclerView, Impl impl, Callback itemTouchHelperCallback) {
