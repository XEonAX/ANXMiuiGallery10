...
class RefocusEffectAdapter extends Adapter<RefocusEffectItemHolder> implements Selectable {
    private Context mContext;
    private Delegator mDelegator = new Delegator(0);
    private final List<RefocusEffectConfig> mRefocusEffectConfigs;

    RefocusEffectAdapter(List<RefocusEffectConfig> refocusEffectConfigs, Context context) {
