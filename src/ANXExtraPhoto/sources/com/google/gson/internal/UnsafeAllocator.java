    ...
    public static UnsafeAllocator create() {
        try {
            ...
            try {
                ...
                try {
                    newInstance = ObjectStreamClass.class.getDeclaredMethod("getConstructorId", new Class[]{Class.class});
                    newInstance.setAccessible(true);
                    final int constructorId = ((Integer) newInstance.invoke(null, new Object[]{Object.class})).intValue();
