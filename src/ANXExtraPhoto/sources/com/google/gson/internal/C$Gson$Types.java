...
public final class C$Gson$Types {
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public ParameterizedTypeImpl(Type ownerType, Type rawType, Type... typeArguments) {
            ...
            if (rawType instanceof Class) {
                ...
                boolean z = true;
                boolean z2 = ownerType != null || rawTypeAsClass.getEnclosingClass() == null;
    ...
    public static Type resolve(Type context, Class<?> contextRawType, Type toResolve) {
        ...
        if ((toResolve instanceof Class) && ((Class) toResolve).isArray()) {
            ...
            return componentType == newComponentType ? original : C$Gson$Types.arrayOf(newComponentType);
        } else if (toResolve instanceof GenericArrayType) {
            GenericArrayType original2 = (GenericArrayType) toResolve;
            componentType = original2.getGenericComponentType();
            newComponentType = C$Gson$Types.resolve(context, contextRawType, componentType);
            return componentType == newComponentType ? original2 : C$Gson$Types.arrayOf(newComponentType);
        } else {
            ...
            if (toResolve instanceof ParameterizedType) {
                ...
                return changed ? C$Gson$Types.newParameterizedTypeWithOwner(newOwnerType, original3.getRawType(), args) : original3;
